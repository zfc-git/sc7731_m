...
#endif
struct regulator *lcdvdd_1v8;
static void lcd_vdd_en(bool enable)
{

	lcdvdd_1v8 = regulator_get(NULL,"vddrf1");
	if (IS_ERR(lcdvdd_1v8)) 
	{
		lcdvdd_1v8 = NULL;
	} 
	else 
	{
		regulator_set_voltage(lcdvdd_1v8, 1800000, 1800000);
	}
	if(enable)
		regulator_enable(lcdvdd_1v8);
	else
		regulator_disable(lcdvdd_1v8);
}
