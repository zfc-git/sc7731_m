...
# add for 2713 charge ic @{
ifeq ($(strip $(ZEDIEL_CHARGE_CONFIG)),CHG_IC_2713)
CHARGE_IC_SEL := 2713
endif
# @}

# add for compat charge ic @{
ifeq ($(strip $(ZEDIEL_CHARGE_CONFIG)),CHG_IC_COMPAT)
CHARGE_IC_SEL := compat
endif
# @}
...
# Gather multiuser features
PRODUCT_REVISION := multiuser
include $(APPLY_PRODUCT_REVISION)

PRODUCT_AAPT_CONFIG := mdpi hdpi xhdpi xlarge
...
PRODUCT_PACKAGES += ZedielPcbTest
...
GMS_SUPPORT := yes
$(call inherit-product-if-exists,vendor/sprd/partner/prebuilt_apps/boot/boot_res.mk)
$(call inherit-product-if-exists,vendor/sprd/partner/prebuilt_apps/third_apps.mk)

$(call inherit-product-if-exists, vendor/sprd/partner/prebuilt_apps/preinstall/preinstall.mk)
PRODUCT_PACKAGES += \
    preinstall.sh
#end lxj
