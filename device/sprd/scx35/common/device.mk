...
PRODUCT_COPY_FILES += \
	...
	vendor/sprd/open-source/apps/scripts/ip_monitor.sh:system/bin/ip_monitor.sh \
...
PRODUCT_COPY_FILES += \
	...
	$(ROOTCOMM)/system/etc/.omxregister:system/etc/.omxregister \
...
#add for thermal
PRODUCT_COPY_FILES += vendor/sprd/open-source/res/thermal/scx35/thermalSensorsConfig.xml:system/etc/thermalSensorsConfig.xml
ODUCT_PROPERTY_OVERRIDES += \
