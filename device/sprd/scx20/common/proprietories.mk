...
PRODUCT_COPY_FILES := $(foreach f,$(PROPMODS),vendor/sprd/proprietories/scx20/$(f):$(f))

ADDITIONAL_STATIC_LIB_DIR := vendor/sprd/proprietories/scx20/obj/STATIC_LIBRARIES/libsprd_verify_intermediates/
...
PRODUCT_COPY_FILES += $(foreach f,$(PROPMODSW),vendor/sprd/proprietories/scx20/$(f):$(f))
endif
