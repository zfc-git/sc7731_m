...
# recovery configs
RECOVERYCOMM := device/sprd/scx20/common/recovery
...
TARGET_RECOVERY_NVMERGE_CONFIG := device/sprd/scx20/common/nvmerge.cfg

#SPRD:modem update config
MODEM_UPDATE_CONFIG := true
MODEM_UPDATE_CONFIG_FILE := device/sprd/scx20/common/modem.cfg
...
#memory optimization
TARGET_BOARD_CAMERA_MEMORY_OPTIMIZATION := false
