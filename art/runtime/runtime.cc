...
bool Runtime::is_runtime_started = false;
...
void Runtime::DumpJavaStack(std::ostream& os) NO_THREAD_SAFETY_ANALYSIS {
    if (!Runtime::is_runtime_started) {
      os << " (no java stack, the VM did not started.)\n";
      return;
    }
