...
void cands_ctl_phy_reset(DDR_CHANNEL_NUM_E chn_num)
{
	...
	{
		//reset channel 0 ddr ctl
		reg_bit_set(DDR0_PHY_RET_CFG, 16, 1, 1);
		wait_us(1);
		reg_bit_set(DDR0_PHY_RET_CFG, 16, 1, 0);

		//reset channel 0 ddr phy
		reg_bit_set(DDR_SLEEP_CTRL, 8, 1, 1);
		wait_us(1);
		reg_bit_set(DDR_SLEEP_CTRL, 8, 1, 0);
	}
	else
	{
		//reset channel 1 ddr ctl
		reg_bit_set(DDR1_PHY_RET_CFG, 17, 1, 1);
		wait_us(1);
		reg_bit_set(DDR1_PHY_RET_CFG, 17, 1, 0);

		//reset channel 1 ddr phy
		reg_bit_set(DDR_SLEEP_CTRL, 24, 1, 1);
		wait_us(1);
		reg_bit_set(DDR_SLEEP_CTRL, 24, 1, 0);
	}
}
...
void cands_phy_slice_init(DDR_CHANNEL_NUM_E chn_num,CANDS_PHY_TIMING_T *phy_timing_info, uint32 slice_num)
{
	...
	__raw_writel(CANDS_PHY0_(0)+chn_offset+(slice_num<<10), slice_timing_f0->DEN_PHY_DQ_TIMING_REG);
	__raw_writel(CANDS_PHY0_(1)+chn_offset+(slice_num<<10), slice_timing_f0->DEN_PHY_DQS_TIMING_REG);
	__raw_writel(CANDS_PHY0_(2)+chn_offset+(slice_num<<10), slice_timing_f0->DEN_PHY_GATE_LPBK_CTRL_REG);
	__raw_writel(CANDS_PHY0_(3)+chn_offset+(slice_num<<10), slice_timing_f0->DEN_PHY_READ_CTRL_REG);
	__raw_writel(CANDS_PHY0_(4)+chn_offset+(slice_num<<10), slice_timing_f0->PHY_DLL_MASTER_CTRL_REG);
	__raw_writel(CANDS_PHY0_(5)+chn_offset+(slice_num<<10), slice_timing_f0->PHY_DLL_SLAVE_CTRL_REG);
	__raw_writel(CANDS_PHY0_(6)+chn_offset+(slice_num<<10), slice_timing_f0->DEN_PHY_IE_TIMING_REG);
  
	__raw_writel(CANDS_PHY0_(7)+chn_offset+(slice_num<<10), slice_timing_f1->DEN_PHY_DQ_TIMING_REG);
	__raw_writel(CANDS_PHY0_(8)+chn_offset+(slice_num<<10), slice_timing_f1->DEN_PHY_DQS_TIMING_REG);
	__raw_writel(CANDS_PHY0_(9)+chn_offset+(slice_num<<10), slice_timing_f1->DEN_PHY_GATE_LPBK_CTRL_REG);
	__raw_writel(CANDS_PHY0_(10)+chn_offset+(slice_num<<10), slice_timing_f1->DEN_PHY_READ_CTRL_REG);
	__raw_writel(CANDS_PHY0_(11)+chn_offset+(slice_num<<10), slice_timing_f1->PHY_DLL_MASTER_CTRL_REG);
	__raw_writel(CANDS_PHY0_(12)+chn_offset+(slice_num<<10), slice_timing_f1->PHY_DLL_SLAVE_CTRL_REG);
	__raw_writel(CANDS_PHY0_(13)+chn_offset+(slice_num<<10), slice_timing_f1->DEN_PHY_IE_TIMING_REG);
                                                     
	__raw_writel(CANDS_PHY0_(14)+chn_offset+(slice_num<<10), slice_timing_f2->DEN_PHY_DQ_TIMING_REG);
	__raw_writel(CANDS_PHY0_(15)+chn_offset+(slice_num<<10), slice_timing_f2->DEN_PHY_DQS_TIMING_REG);
	__raw_writel(CANDS_PHY0_(16)+chn_offset+(slice_num<<10), slice_timing_f2->DEN_PHY_GATE_LPBK_CTRL_REG);
	__raw_writel(CANDS_PHY0_(17)+chn_offset+(slice_num<<10), slice_timing_f2->DEN_PHY_READ_CTRL_REG);
	__raw_writel(CANDS_PHY0_(18)+chn_offset+(slice_num<<10), slice_timing_f2->PHY_DLL_MASTER_CTRL_REG);
	__raw_writel(CANDS_PHY0_(19)+chn_offset+(slice_num<<10), slice_timing_f2->PHY_DLL_SLAVE_CTRL_REG);
	__raw_writel(CANDS_PHY0_(20)+chn_offset+(slice_num<<10), slice_timing_f2->DEN_PHY_IE_TIMING_REG);
	                                                   
	__raw_writel(CANDS_PHY0_(21)+chn_offset+(slice_num<<10), slice_timing_f3->DEN_PHY_DQ_TIMING_REG);
	__raw_writel(CANDS_PHY0_(22)+chn_offset+(slice_num<<10), slice_timing_f3->DEN_PHY_DQS_TIMING_REG);
	__raw_writel(CANDS_PHY0_(23)+chn_offset+(slice_num<<10), slice_timing_f3->DEN_PHY_GATE_LPBK_CTRL_REG);
	__raw_writel(CANDS_PHY0_(24)+chn_offset+(slice_num<<10), slice_timing_f3->DEN_PHY_READ_CTRL_REG);
	__raw_writel(CANDS_PHY0_(25)+chn_offset+(slice_num<<10), slice_timing_f3->PHY_DLL_MASTER_CTRL_REG);
	__raw_writel(CANDS_PHY0_(26)+chn_offset+(slice_num<<10), slice_timing_f3->PHY_DLL_SLAVE_CTRL_REG);
	__raw_writel(CANDS_PHY0_(27)+chn_offset+(slice_num<<10), slice_timing_f3->DEN_PHY_IE_TIMING_REG);
                                                     
	__raw_writel(CANDS_PHY0_(33)+chn_offset+(slice_num<<10), slice_timing_f0->PHY_LVL_CONFIG_REG);
	__raw_writel(CANDS_PHY0_(34)+chn_offset+(slice_num<<10), slice_timing_f1->PHY_LVL_CONFIG_REG);
	__raw_writel(CANDS_PHY0_(35)+chn_offset+(slice_num<<10), slice_timing_f2->PHY_LVL_CONFIG_REG);
	__raw_writel(CANDS_PHY0_(36)+chn_offset+(slice_num<<10), slice_timing_f3->PHY_LVL_CONFIG_REG);	
                                                     
	__raw_writel(CANDS_PHY0_(39)+chn_offset+(slice_num<<10), slice_timing_f0->PHY_WRLVL_CONFIG_REG);
	__raw_writel(CANDS_PHY0_(40)+chn_offset+(slice_num<<10), slice_timing_f1->PHY_WRLVL_CONFIG_REG);
	__raw_writel(CANDS_PHY0_(41)+chn_offset+(slice_num<<10), slice_timing_f2->PHY_WRLVL_CONFIG_REG);
	__raw_writel(CANDS_PHY0_(42)+chn_offset+(slice_num<<10), slice_timing_f3->PHY_WRLVL_CONFIG_REG);	
...
//    reg_bit_set(CANDS_PHY0_(334)+chn_offset, 1, 4, DDR_DS);    //read dm ds
    ...
    //clk ds
    reg_bit_set(CANDS_PHY0_(336)+chn_offset, 31, 1, 0);    //pod off
    reg_bit_set(CANDS_PHY0_(336)+chn_offset, 28, 1, 0);    //rpull off
    reg_bit_set(CANDS_PHY0_(336)+chn_offset, 16, 4, DDR_DS);//nmos
    reg_bit_set(CANDS_PHY0_(336)+chn_offset, 20, 4, LPDDR3_DS_48R);//pmos
...
{	
	...
	__raw_writel(CANDS_CTL0_(120)+chn_offset, (1<<8) | //zqcs to all cs when set 1
		                 			       (1<<0));  //disable ZQ during initialization, set 0 to enable
...
void cands_ctl_qos_init(DDR_CHANNEL_NUM_E chn_num,CANDS_QOS_T * port_info)
{
    ...
    reg_bit_set(CANDS_CTL0_(125)+chn_offset,   0, 5, 0x1b);    
    //swap_en
    ...
    //q_fullness
    reg_bit_set(CANDS_CTL0_(127)+chn_offset,  16, 5, 0);
    //in_order_accept
    reg_bit_set(CANDS_CTL0_(127)+chn_offset,  24, 1, 0);

    //arb_cmd_q_threshold
    reg_bit_set(CANDS_CTL0_(914)+chn_offset,  16, 5, 0); //should check !!!
    ...
    reg_bit_set(CANDS_CTL0_(912)+chn_offset,  24, 1, 0); //should check !!!
    reg_bit_set(CANDS_CTL0_(913)+chn_offset,   0, 1, 0); //should check !!!
    reg_bit_set(CANDS_CTL0_(913)+chn_offset,   8, 1, 0); //should check !!!
    reg_bit_set(CANDS_CTL0_(913)+chn_offset,  16, 1, 0); //should check !!!
    reg_bit_set(CANDS_CTL0_(913)+chn_offset,  24, 1, 0); //should check !!!    
    reg_bit_set(CANDS_CTL0_(914)+chn_offset,   0, 1, 0); //should check !!!
    reg_bit_set(CANDS_CTL0_(914)+chn_offset,   8, 1, 0); //should check !!!
    reg_bit_set(CANDS_CTL0_(914)+chn_offset,  16, 1, 0); //should check !!!
    reg_bit_set(CANDS_CTL0_(914)+chn_offset,  24, 1, 0); //should check !!!
    reg_bit_set(CANDS_CTL0_(915)+chn_offset,   0, 1, 0); //should check !!!
    //axiY_all_strobes_used_enable
    reg_bit_set(CANDS_CTL0_(180)+chn_offset,   0, 1, port_info[0].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(181)+chn_offset,   0, 1, port_info[1].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(182)+chn_offset,   0, 1, port_info[2].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(183)+chn_offset,   0, 1, port_info[3].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(185)+chn_offset,   0, 1, port_info[4].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(186)+chn_offset,   0, 1, port_info[5].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(187)+chn_offset,   0, 1, port_info[6].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(188)+chn_offset,   0, 1, port_info[7].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(190)+chn_offset,   0, 1, port_info[8].ALL_STRB_EN);
    reg_bit_set(CANDS_CTL0_(191)+chn_offset,   0, 1, port_info[9].ALL_STRB_EN);
    //axiY_bdw
...
void ddr_init(DDR_CHANNEL_NUM_E chn_num)
{
