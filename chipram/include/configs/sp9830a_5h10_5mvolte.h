...
#define CLK_CA7_CORE    ARM_CLK_1350M
#else
#define CLK_CA7_CORE    ARM_CLK_768M
#endif
...
//32 + 4 config for this product, the hardware is 64+8
//the macro of SP9830A_5H10_32V4_VOLTE_CHIPRAM comes from CHIPRAM_CONFIG_PRODUCT, combines with _CHIPRAM in "mkconfig"
#if defined SP9830A_5H10_32V4_VOLTE_CHIPRAM       
#define DDR_SIZE_FIXED_ON
#define DDR_FIXED_SIZE 0x20000000
#else		//default status, use DDR_AUTO_DETECT mode
