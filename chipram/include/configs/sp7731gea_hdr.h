...
#if defined(DDR_SCAN_SUPPORT_28NM)
#define DDR_LPDDR3
#endif
...
#if defined (AUTO_DETECT_DDR)
  #define DDR_AUTO_DETECT
  #define ADAPT_LPDDR2_LPDDR3
 #define DDR_FREQ        400000000
#elif defined (LPDDR2_1CS_4G_X32)
	#define DDR_LPDDR2
  #define DDR_TYPE DRAM_LPDDR2_1CS_4G_X32
#elif defined (LPDDR2_1CS_8G_X32)
	#define DDR_LPDDR2
  #define DDR_TYPE DRAM_LPDDR2_1CS_8G_X32
#elif defined (LPDDR2_2CS_8G_X32)
	#define DDR_LPDDR2
  #define DDR_TYPE DRAM_LPDDR2_2CS_8G_X32
#elif defined (LPDDR2_2CS_8G_X32_333M)
	#define DDR_LPDDR2
	#define DDR_FREQ        333000000
	#define DDR_TYPE DRAM_LPDDR2_2CS_8G_X32
#elif defined (LPDDR2_2CS_16G_X32)
	#define DDR_LPDDR2
  #define DDR_TYPE DRAM_LPDDR2_2CS_16G_X32
#elif defined (DDR3_1CS_2G_X8_4P)
	#define DDR_LPDDR3
  #define DDR_TYPE DRAM_DDR3_1CS_2G_X8_4P
#elif defined (LPDDR3_2CS_8G_X32)
	#define DDR_LPDDR3
  #define DDR_TYPE DRAM_LPDDR3_2CS_8G_X32
#elif defined (LPDDR2_1CS_4G_X16_2P)
	#define DDR_LPDDR2
  #define DDR_TYPE DRAM_LPDDR2_1CS_4G_X16_2P
#endif
