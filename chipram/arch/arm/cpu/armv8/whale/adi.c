...
static void __adi_init(void)
{
	...
	if (__adi_ver() == 0) {
		...
		value = REG32(REG_ADI_GSSI_CFG1);
		value |= STARTBIT_MODE;
		REG32(REG_ADI_GSSI_CFG1)=value;
	}
#endif  /* CONFIG_SP9630FPGA */
}
