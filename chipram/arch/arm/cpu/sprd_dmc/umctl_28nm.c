...
#include "asm/arch/chip_x30g/__regs_ana_sc2713s_glb.h"
#elif defined(CONFIG_ADIE_SC2723S) || defined(CONFIG_ADIE_SC2723)
#include "asm/arch/chip_x30g/__regs_ana_sc2723_glb.h"
#endif
#endif
...
dram_timing_t DDR_TIMING_INFO_LPDDR2[] =
{
	{CLK_200MHZ, //ddr_clk
	 0x0d0B0D0A, //dramtmg0
	 LPDDR2_DRAMTMG_1_200M, //dramtmg1
	 0x03060B09, //dramtmg2
	 0x00502000, //dramtmg3
	 LPDDR2_DRAMTMG_4_200M, //dramtmg4
	 0x02020303, //dramtmg5
	 0x02020005, //dramtmg6
	 0x00000202, //dramtmg7
	 0x03030202, //dramtmg8
	 ...
	 {CLK_333MHZ, //ddr_clk
	 0x0F161B13, //dramtmg0
	 LPDDR2_DRAMTMG_1_400M, //dramtmg1
	 0x03060A0A, //dramtmg2
	 0x00502000, //dramtmg3
	 LPDDR2_DRAMTMG_4_400M, //dramtmg4
	 0x02020707, //dramtmg5
	 0x02020006, //dramtmg6
	 0x00000202, //dramtmg7
	 0x04040303, //dramtmg8
	...
	{CLK_384MHZ, //ddr_clk
	 0x0F161B13, //dramtmg0
	 LPDDR2_DRAMTMG_1_384M, //dramtmg1
	 0x03060A0A, //dramtmg2
	 0x00502000, //dramtmg3
	 LPDDR2_DRAMTMG_4_384M, //dramtmg4
	 0x02020707, //dramtmg5
	 0x02020006, //dramtmg6
	 0x00000202, //dramtmg7
	 0x04040303, //dramtmg8
	...
	{CLK_466MHZ, //ddr_clk
	 0x12191F15, //dramtmg0
	 LPDDR2_DRAMTMG_1_466M, //dramtmg1
	 0x04070A0C, //dramtmg2
	 0x00502000, //dramtmg3
	 LPDDR2_DRAMTMG_4_466M, //dramtmg4
	 0x02020808, //dramtmg5
	 0x02020007, //dramtmg6
	 0x00000202, //dramtmg7
	 0x05050404, //dramtmg8
	...
	{CLK_500MHZ, //ddr_clk
	 0x0F1A2217, //dramtmg0
	 LPDDR2_DRAMTMG_1_500M, //dramtmg1
	 0x04070A0B, //dramtmg2
	 0x00502000, //dramtmg3
	 LPDDR2_DRAMTMG_4_500M, //dramtmg4
	 0x02020808, //dramtmg5
	 0x02020007, //dramtmg6
	 0x00000202, //dramtmg7
	 0x05050404, //dramtmg8
...
dram_timing_t DDR_TIMING_INFO_LPDDR3[] =
{
#ifndef CONFIG_SPX30G
    {CLK_192MHZ, //ddr_clk
	 0x0E0A0D09, //dramtmg0
	 LPDDR3_DRAMTMG_1_192M, //dramtmg1
	 0x03060A0C, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_192M, //dramtmg4
	 0x02020303, //dramtmg5
	 0x02020005, //dramtmg6
	 0x00000202, //dramtmg7
	 0x03030202, //dramtmg8
...
//	 0x00030202, //dfitmg1
	...
	{CLK_200MHZ, //ddr_clk
	 0x0E0A0D09, //dramtmg0
	 LPDDR3_DRAMTMG_1_200M, //dramtmg1
	 0x03060A0C, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_200M, //dramtmg4
	 0x02020303, //dramtmg5
	 0x02020005, //dramtmg6
	 0x00000202, //dramtmg7
	 0x03030202, //dramtmg8
...
//	 0x00030202, //dfitmg1
	...
	{CLK_384MHZ, //ddr_clk
	 0x0F141A11, //dramtmg0
	 LPDDR3_DRAMTMG_1_384M, //dramtmg1
	 0x03060B0C, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_384M, //dramtmg4
	 0x02020606, //dramtmg5
	 0x02020005, //dramtmg6
	 0x00000202, //dramtmg7
	 0x04040303, //dramtmg8
...
//	 0x00030202, //dfitmg1
     ...
     {CLK_400MHZ, //ddr_clk
	 0x0F141B12, //dramtmg0
	 LPDDR3_DRAMTMG_1_400M, //dramtmg1
	 0x03060B0C, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_400M, //dramtmg4
	 0x02020606, //dramtmg5
	 0x02020005, //dramtmg6
	 0x00000202, //dramtmg7
	 0x04040303, //dramtmg8
...
//	 0x00030202, //dfitmg1
     ...
     {CLK_500MHZ, //ddr_clk
	 0x12192216, //dramtmg0
	 LPDDR3_DRAMTMG_1_500M, //dramtmg1
	 0x04080C0D, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_500M, //dramtmg4
	 0x02020808, //dramtmg5
	 0x02020006, //dramtmg6
	 0x00000202, //dramtmg7
	 0x05050404, //dramtmg8
...
//	 0x00030202, //dfitmg1
	...
	//add for pikel 533
	  {CLK_533MHZ, //ddr_clk
	   0x141B2418, //dramtmg0
	   LPDDR3_DRAMTMG_1_533M, //dramtmg1
	   0x04080c0d, //dramtmg2
	   0x00a0a000, //dramtmg3
	   LPDDR3_DRAMTMG_4_533M, //dramtmg4
	   0x02020808, //dramtmg5
	   0x02020006, //dramtmg6
	   0x00000202, //dramtmg7
	   0x05050404, //dramtmg8
	...
	{CLK_600MHZ, //ddr_clk
	 0x141e291b, //dramtmg0
	 LPDDR3_DRAMTMG_1_600M, //dramtmg1
	 0x05090D0f, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_600M, //dramtmg4
	 0x02020909, //dramtmg5
	 0x02020007, //dramtmg6
	 0x00000202, //dramtmg7
	 0x06060404, //dramtmg8
...
//	 0x00030202, //dfitmg1
	...
	{CLK_614MHZ, //ddr_clk
	 0x161F291C, //dramtmg0
	 LPDDR3_DRAMTMG_1_614M, //dramtmg1
	 0x060A0D10, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_614M, //dramtmg4
	 0x02020A0A, //dramtmg5
	 0x02020007, //dramtmg6
	 0x00000202, //dramtmg7
	 0x06060404, //dramtmg8 -- confirm
	 0x004A0050, //rfshtmg_s
	 0x004A0081, //rfshtmg_l    /*for 1 cs 8g DDR */
	 0x00780001, //init0
	 0x00000000, //init1
	 0x00001405, //init2
	 0x00030018, //init3
...
//	 0x00030202, //dfitmg1
	...
	{CLK_640MHZ, //ddr_clk
	 0x16202B1D, //dramtmg0
	 LPDDR3_DRAMTMG_1_640M, //dramtmg1
	 0x060A0D10, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_640M, //dramtmg4
	 0x02020A0A, //dramtmg5
	 0x02020007, //dramtmg6
	 0x00000202, //dramtmg7
	 0x06060404, //dramtmg8
...
//	 0x00030202, //dfitmg1
	...
	{CLK_667MHZ, //ddr_clk
	 0x17222d1e, //dramtmg0
	 LPDDR3_DRAMTMG_1_667M, //dramtmg1
	 0x060A0D11, //dramtmg2
	 0x00A0A000, //dramtmg3
	 LPDDR3_DRAMTMG_4_667M, //dramtmg4
	 0x02020b0b, //dramtmg5
	 0x02020008, //dramtmg6
	 0x00000202, //dramtmg7
	 0x06060404, //dramtmg8
...
//	 0x00030202, //dfitmg1
	...
	{CLK_800MHZ, //ddr_clk
	 0x18283624, //dramtmg0
	 LPDDR3_DRAMTMG_1_800M, //dramtmg1
	 0x060c1011, //dramtmg2
	 0x00A0c000, //dramtmg3
	 LPDDR3_DRAMTMG_4_800M, //dramtmg4
	 0x02020c0c, //dramtmg5
	 0x02020008, //dramtmg6
	 0x00000202, //dramtmg7
	 0x07070505, //dramtmg8
...
dram_timing_t *DDR_TIMING_INFO_POINTER;
uint32 TIMING_INFO_SIZE;
...
CLK_TYPE_E DDR_DFS_POINT_LPDDR2[] =
{
	CLK_200MHZ,
	CLK_333MHZ,
	//CLK_384MHZ,
...
CLK_TYPE_E DDR_DFS_POINT_LPDDR3[] =
{
	CLK_192MHZ,
	CLK_384MHZ,
	//CLK_600MHZ,
...
void umctl_basic_mode_init(DRAM_INFO_T *dram)
{
	...
	dmc_reg_bits_set((uint32)&umctl->umctl_mstr,0,4, ((dram_type == DRAM_LPDDR1)?0x2:0x00)|
...
void umctl_poweron_init(CLK_TYPE_E dmc_clk,DRAM_INFO_T *dram)
{
    ...
    for(i = 0; i < TIMING_INFO_SIZE; i++)
	{
		if(dmc_clk == DDR_TIMING_INFO_POINTER[i].ddr_clk)
		{
		    umctl->umctl_init[0] = DDR_TIMING_INFO_POINTER[i].init0;
		    umctl->umctl_init[1] = DDR_TIMING_INFO_POINTER[i].init1;
		    umctl->umctl_init[2] = DDR_TIMING_INFO_POINTER[i].init2;
		    umctl->umctl_init[3] = DDR_TIMING_INFO_POINTER[i].init3;
		    umctl->umctl_init[4] = DDR_TIMING_INFO_POINTER[i].init4;
		    umctl->umctl_init[5] = DDR_TIMING_INFO_POINTER[i].init5;
		}
	}
}
...
static void umctl_dramtiming_init(CLK_TYPE_E dmc_clk,DRAM_INFO_T *dram)
{
    ...
    for(i = 0; i < TIMING_INFO_SIZE; i++)
	{
		if(dmc_clk == DDR_TIMING_INFO_POINTER[i].ddr_clk)
		{
			umctl->umctl_dramtmg[0] = DDR_TIMING_INFO_POINTER[i].dramtmg0;
			umctl->umctl_dramtmg[1] = DDR_TIMING_INFO_POINTER[i].dramtmg1;
			umctl->umctl_dramtmg[2] = DDR_TIMING_INFO_POINTER[i].dramtmg2;
			umctl->umctl_dramtmg[3] = DDR_TIMING_INFO_POINTER[i].dramtmg3;
			umctl->umctl_dramtmg[4] = DDR_TIMING_INFO_POINTER[i].dramtmg4;
			umctl->umctl_dramtmg[5] = DDR_TIMING_INFO_POINTER[i].dramtmg5;
			umctl->umctl_dramtmg[6] = DDR_TIMING_INFO_POINTER[i].dramtmg6;
			umctl->umctl_dramtmg[7] = DDR_TIMING_INFO_POINTER[i].dramtmg7;
			if(dram->row_num >= 15)
			{
				umctl->umctl_dramtmg[8] = (DDR_TIMING_INFO_POINTER[i].dramtmg8 >> 16) & 0xFFFF;
			}
			else
			{
				umctl->umctl_dramtmg[8] = DDR_TIMING_INFO_POINTER[i].dramtmg8 & 0xFFFF;
			}
		}
	}
}
...
#ifndef CONFIG_SPX30G
#define SHARKLC_AON_CHIP_ID_ADDRESS   0x402e00fc
#define SHARKLC_CHIP_ID 0x96301000

static uint32 get_chip_id()
{   
	return *(volatile uint32 *)(SHARKLC_AON_CHIP_ID_ADDRESS);
}

/*
1. add for pikel  and sharklc
*/
void publ_acio_init()
{
	int i;
...
static void is_ddr_freq_is_614m(int ddr_clk)
{
	int i;
	if((get_chip_id() == SHARKLC_CHIP_ID) || (ddr_clk == 614))
	{
		for(i = 0; i <ARRAY_SIZE(DDR_DFS_POINT_LPDDR3); i++)
		{
			DDR_DFS_POINT_LPDDR3[i] = 0;
		}
		DDR_DFS_POINT_LPDDR3[0] = CLK_192MHZ;
		DDR_DFS_POINT_LPDDR3[1] = CLK_384MHZ;
		DDR_DFS_POINT_LPDDR3[2] = CLK_500MHZ;
		DDR_DFS_POINT_LPDDR3[3] = CLK_614MHZ;
	}
}
#endif
...
static void umctl_addrmap_init(DRAM_INFO_T *dram)
{
	...
	switch(dram->dram_type)
	{
		...
		case DRAM_LPDDR2_2CS_8G_X16_2P:
...
/*		case DRAM_LPDDR2_1CS_2G_X32:
		...
		case DRAM_LPDDR3_1CS_4G_X16_2P:
			umctl->umctl_addrmap[0] = 0x00001F1F;
...
static void umctl_refresh_init(CLK_TYPE_E dmc_clk,DRAM_INFO_T *dram)
{
    ...
    for(i = 0; i < TIMING_INFO_SIZE; i++)
	{
		if(dmc_clk == DDR_TIMING_INFO_POINTER[i].ddr_clk)
		{
            if(dram->row_num >= 15)
			{
                umctl->umctl_rfshtmg = DDR_TIMING_INFO_POINTER[i].rfshtmg_l;
			}
			else
			{
                umctl->umctl_rfshtmg = DDR_TIMING_INFO_POINTER[i].rfshtmg_s;
			}
		}
	}
...
static void umctl_zqctl_init(CLK_TYPE_E dmc_clk,DRAM_INFO_T *dram)
{
	...
	for(i = 0; i < TIMING_INFO_SIZE; i++)
	{
		if(dmc_clk == DDR_TIMING_INFO_POINTER[i].ddr_clk)
		{
            umctl->umctl_zqctl[0] = DDR_TIMING_INFO_POINTER[i].zqctl0;
			umctl->umctl_zqctl[1] = DDR_TIMING_INFO_POINTER[i].zqctl1;
		}
	}
}
...
static void umctl_dfi_init(CLK_TYPE_E dmc_clk,DRAM_INFO_T *dram)
{
     ...
     for(i = 0; i < TIMING_INFO_SIZE; i++)
	{
		if(dmc_clk == DDR_TIMING_INFO_POINTER[i].ddr_clk)
		{
            umctl->umctl_dfitmg[0] = DDR_TIMING_INFO_POINTER[i].dfitmg0;
		}
	}
...
static void umctl_odt_init(CLK_TYPE_E dmc_clk,DRAM_INFO_T *dram)
{
	...
	/*rd odt delay*/
	dmc_reg_bits_set((uint32)&umctl->umctl_odtcfg, 2,4,0);
	/*wr odt block*/
	...
	if(dram->dram_type == DRAM_LPDDR3)
	{
	    for(i = 0; i < TIMING_INFO_SIZE; i++)
		{
			if(dmc_clk == DDR_TIMING_INFO_POINTER[i].ddr_clk)
			{
	            umctl->umctl_odtcfg = DDR_TIMING_INFO_POINTER[i].odtcfg;
			}
		}
...
#else
	UMCTL2_REG_SET(UMCTL_PERFLPR1, 0x10000040);//sharkl & sharkl-t8 ramspeed optimize
#endif
	//UMCTL2_REG_SET(UMCTL_PERFWR0,  0x00000020);
#ifdef CONFIG_SCX35LT8
...
void publ_mdr_init(CLK_TYPE_E dmc_clk,DRAM_INFO_T *dram)
{
	...
	if(dram_type == DRAM_LPDDR2) {
		...
		for(i = 0; i < TIMING_INFO_SIZE; i++)
		{
			if(dmc_clk == DDR_TIMING_INFO_POINTER[i].ddr_clk)
			{
      	publ->publ_mr[1] = DDR_TIMING_INFO_POINTER[i].mr1;
				publ->publ_mr[2] = DDR_TIMING_INFO_POINTER[i].mr2;
			}
		}
...
#ifndef CONFIG_SPX30G
	if(get_chip_id() == SHARKLC_CHIP_ID)
	{
		publ_acio_init();
		publ_dxng_init();
	}
...
CLK_TYPE_E *DDR_DFS_POINT_POINTER;
uint32 DDR_DFS_POINT_SIZE;
#ifdef DDR_DFS_SUPPORT
#ifndef CONFIG_SPX30G
...
static DDR_TYPE_E ddr_type_info[] = {S4_SDRAM, S8_SDRAM};
static DDR_SIZE_E ddr_size_info[] = {SIZE_128MB,SIZE_256MB,SIZE_512MB,SIZE_1GB,SIZE_2GB,SIZE_4GB,SIZE_6GB,SIZE_8GB,SIZE_12GB,SIZE_16GB};
...
void __sdram_auto_detect(void)
{
...
#if defined(ADAPT_LPDDR2_LPDDR3)
	DDR_TYPE_LOCAL = DRAM_LPDDR2_2CS_8G_X32;
	dram_info = get_dram_cfg(DDR_TYPE_LOCAL);


	DDR_DFS_POINT_POINTER = DDR_DFS_POINT_LPDDR2;
	DDR_DFS_POINT_SIZE = ARRAY_SIZE(DDR_DFS_POINT_LPDDR2);
	DDR_TIMING_INFO_POINTER = DDR_TIMING_INFO_LPDDR2;
	TIMING_INFO_SIZE = ARRAY_SIZE(DDR_TIMING_INFO_LPDDR2);
#elif defined(DDR_LPDDR2)
	DDR_TYPE_LOCAL = DRAM_LPDDR2_2CS_8G_X32;
	dram_info = get_dram_cfg(DDR_TYPE_LOCAL);
	...
	DDR_DFS_POINT_POINTER = DDR_DFS_POINT_LPDDR3;
	DDR_DFS_POINT_SIZE = ARRAY_SIZE(DDR_DFS_POINT_LPDDR3);
	DDR_TIMING_INFO_POINTER = DDR_TIMING_INFO_LPDDR3;
	TIMING_INFO_SIZE = ARRAY_SIZE(DDR_TIMING_INFO_LPDDR3);
#else
	#error no ddr type is selected
#endif


	__cal_actiming(dram_info,DDR_DFS_POINT_POINTER[0]);
#ifdef PIKEL_DRIVER_SUPPORT_ON
	if(get_chip_id() == PIKEL_CHIP_ID)
	{
	...
	{
		__sdram_init(DDR_DFS_POINT_POINTER[0], UMCTL2_PORT_CONFIG, dram_info, 1);
	}
#else
	__sdram_init(DDR_DFS_POINT_POINTER[0], UMCTL2_PORT_CONFIG, dram_info, 1);
#endif
  ...
  ddr_print_char(DDR_TYPE_LOCAL>>8);
  ddr_print_char(DDR_TYPE_LOCAL); 
#if defined(ADAPT_LPDDR2_LPDDR3)
	/* config points according  to detected ddr type */
	if(IS_LPDDR3(DDR_TYPE_LOCAL))
	{
		DDR_DFS_POINT_POINTER = DDR_DFS_POINT_LPDDR3;
		DDR_DFS_POINT_SIZE = ARRAY_SIZE(DDR_DFS_POINT_LPDDR3);
...
void sdram_init(void)
{
    ...
    for(i = 0; i < 256; i++)
	{
		...
		else if(IS_LPDDR2(DDR_TYPE_LOCAL))
		{
			DDR_DFS_POINT_POINTER = DDR_DFS_POINT_LPDDR2;
			DDR_DFS_POINT_SIZE = ARRAY_SIZE(DDR_DFS_POINT_LPDDR2);
		...
		{
			ddr_print("\r\n no valid ddr type is define by user");
			while(1);
		}
	#endif


	for(i = 0; i <DDR_DFS_POINT_SIZE; i++)
	{
	   dram_info = get_dram_cfg(DDR_TYPE_LOCAL);

		if(DDR_DFS_POINT_POINTER[i] > ddr_clk)
		{
			if(i > 0)
			{
				i--;
		...
		__cal_actiming(dram_info,DDR_DFS_POINT_POINTER[i]);
#ifdef PIKEL_DRIVER_SUPPORT_ON
		if(get_chip_id() == PIKEL_CHIP_ID)
		{
		...
		{
			__sdram_init(DDR_DFS_POINT_POINTER[i], UMCTL2_PORT_CONFIG, dram_info,0);
		}
#else
			__sdram_init(DDR_DFS_POINT_POINTER[i], UMCTL2_PORT_CONFIG, dram_info,0);
#endif
...
#ifndef CONFIG_SPX30G
		record_dfs_val(DDR_DFS_POINT_POINTER[i], DDR_DFS_VAL_BASE+sizeof(mem_cs_info_t)+sizeof(ddr_dfs_val_t)*i);
		if(DDR_DFS_POINT_POINTER[i] >= ddr_clk)
		{
...
#ifndef CONFIG_SPX30G
	REG32(DDR_DFS_VAL_BASE+sizeof(mem_cs_info_t)+sizeof(ddr_dfs_val_t)*DDR_DFS_POINT_SIZE) = 0x12345678;
#endif
