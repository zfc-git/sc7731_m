...
{DRAM_LPDDR2_2CS_12G_X32, 2, 	 8, 	 32,    14,    0,  4,  6,  3,  0,   &lpddr2_actiming,  &LPDDR2_ACTIMING_NATIVE},
{DRAM_LPDDR2_2CS_16G_X32, 2, 	 8, 	 32,    14,    0,  4,  6,  3,  0,   &lpddr2_actiming,  &LPDDR2_ACTIMING_NATIVE},
{DRAM_LPDDR2_2CS_8G_X16_2P, 2,   8,      32,    14,    0,  4,  6,  3,  0,   &lpddr2_actiming,  &LPDDR2_ACTIMING_NATIVE},
...
{DRAM_LPDDR3_1CS_4G_X16_2P, 1,   8,      32,    14,    0,  8,  6,  3,  0,   &lpddr3_actiming,  &LPDDR3_ACTIMING_NATIVE},
};
...
//rw_order r_hpr r_pg  r_ugent r_age r_rord_bp r_age_cnt, w_pg  w_ugent w_age  w_age_cnt
    ...
    {FALSE, TRUE,  TRUE, FALSE,  TRUE,   FALSE,     0x002,   TRUE, FALSE,  TRUE,  0x002},//port8,cp1 dsp
    {FALSE, TRUE,  TRUE, FALSE,  TRUE,   FALSE,     0x010,   TRUE, FALSE,  TRUE,  0x010}, //port9,CP1 ca5
    {0xff},
};
