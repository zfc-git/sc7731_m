...
{LCM_SEND(5),{3,0,0xBC,0x60,0x00}},
{LCM_SEND(5),{3,0,0xBD,0x60,0x00}},
{LCM_SEND(2),{0xBE,0x56}},//50add by heliang 20170808  VCOM
...
static int32_t nt35521s_n070icn_mipi_init(struct panel_spec *self)
{
	LCD_PRINT("[%s][%d] nt35521s_n070icn_mipi_init Enter!\n",__FUNCTION__,__LINE__);
	int32_t i;
	...
	LCD_PRINT("[%s] Lancewu lcd_nt35521s_n070icn_init\n",__FUNCTION__);

	//nt35521s_n070icn_mipi_set_lcmvdd();
	
	udelay(2*1000);
	mipi_set_cmd_mode();
	mipi_eotp_set(1,0);

	LCD_PRINT("lcd_nt35521s_n070icn data size: %d\n",ARRAY_SIZE(init_data));
...
static uint32_t nt35521s_n070icn_readid(struct panel_spec *self)
{
	...
	printk("uboot lcd_nt35521s_n070icn_mipi read id!\n");
	#if 0
	mipi_set_lp_mode();
	...
	for(j = 0; j < 4; j++){
		...
		//printk("lcd_nt35521s_n070icn_mipi read id 0x04 value is,0x%x!\n", read_data[0]);
		printk("lcd_nt35521s_n070icn_mipi read id 0x04 value is,0x%x,,0x%x,,0x%x!\n", read_data[0], read_data[1], read_data[2]);

		if((0x93 == read_data[0])){
			printk("lcd_nt35521s_n070icn_mipi read id success!\n");
			return 0x35521;
		}
	}
...
static struct panel_operations lcd_nt35521s_n070icn_mipi_operations = {
	.panel_init = nt35521s_n070icn_mipi_init,
	.panel_readid = nt35521s_n070icn_readid,
};


static struct timing_rgb lcd_nt35521s_n070icn_mipi_timing = {
	.hfp = 65,  /* unit: pixel */
	.hbp = 60,
	.hsync = 6,
	.vfp = 20, /*unit: line*/
...
static struct info_mipi lcd_nt35521s_n070icn_mipi_info = {
	...
	.timing = &lcd_nt35521s_n070icn_mipi_timing,
	.ops = NULL,
};
...
struct panel_spec lcd_nt35521s_n070icn_mipi_spec = {
	...
	.info = {
		.mipi = &lcd_nt35521s_n070icn_mipi_info
	},
	.ops = &lcd_nt35521s_n070icn_mipi_operations,
};
