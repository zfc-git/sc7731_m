...
{LCM_SEND(2),{0x80,0x01}},
//--- Page1  ----//
{LCM_SEND(2),{0xE0,0x01}},
//Set VCOM 
{LCM_SEND(2),{0x01,0x90}},  //0xA0
//Set VCOM_Reverse 
{LCM_SEND(2),{0x04,0x90}},  //0xA0
...
//Set Gate Power
{LCM_SEND(2),{0x1F,0x3E}},     //VGH_R  = 15V ,0X72   888                      
{LCM_SEND(2),{0x20,0x2F}},     //VGL_R  = -12V                      
{LCM_SEND(2),{0x21,0x2F}},     //VGL_R2 = -12V                      
...
//Set TCON
{LCM_SEND(2),{0x40,0x02}},	//RSO=600 RGB
{LCM_SEND(2),{0x41,0x80}},	//LN=512->1024 line
{LCM_SEND(2),{0x44,0x07}},
//--- power voltage  ----//
{LCM_SEND(2),{0x55,0x0F}},	//DCDCM=0001, JD PWR_IC          888
{LCM_SEND(2),{0x56,0x01}},
{LCM_SEND(2),{0x57,0x68}},
{LCM_SEND(2),{0x58,0x0A}},
{LCM_SEND(2),{0x59,0x0A}},	//VCL = -2.9V
{LCM_SEND(2),{0x5A,0x28}},	//VGH = 15V
{LCM_SEND(2),{0x5B,0x1B}},	//VGL = -12V
//--- Gamma  ----//
...
{LCM_SEND(2),{0x5C,0x06}},//STV_S0          888                                                       
...
{LCM_SEND(2),{0x6A,0x98}},//CKV0_OFF                                                         
{LCM_SEND(2),{0x6B,0x00}},//CKV0_DUM        888                                                     
{LCM_SEND(2),{0x6C,0x00}},	//EOLR,GEQ_LINE,GEQ_W                                              
{LCM_SEND(2),{0x6D,0x04}},	//GEQ_GGND1                                                        
{LCM_SEND(2),{0x6E,0x04}},	//GEQ_GGND2                                                        
{LCM_SEND(2),{0x6F,0x88}},	//GIPDR,VGHO_SEL,VGLO_SEL   
...
{LCM_SEND(2),{0x75,0x07}},	//FLM_EN,FLM_W    888                                                
