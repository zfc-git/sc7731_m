/* drivers/video/sc8825/lcd_fy0702_mipi.c
 *
 * Support for fy0702 mipi LCD device
 *
...
static LCM_Init_Code init_data[] ={
	...
	{LCM_SEND(2),{0x1B,0xD8}},
	{LCM_SEND(2),{0x1C,0x01}},
	{LCM_SEND(2),{0x1F,0x74}},
	{LCM_SEND(2),{0x20,0x19}},
		{LCM_SEND(2),{0x21,0x19}},
		{LCM_SEND(2),{0x22,0x0E}},
		{LCM_SEND(2),{0x27,0x43}},
		{LCM_SEND(2),{0x37,0x29}},
		{LCM_SEND(2),{0x38,0x05}},
		{LCM_SEND(2),{0x39,0x08}},
		{LCM_SEND(2),{0x3A,0x18}},
		{LCM_SEND(2),{0x3B,0x18}},
		{LCM_SEND(2),{0x3C,0x72}},
		{LCM_SEND(2),{0x3E,0xFF}},
		{LCM_SEND(2),{0x3E,0xFF}},
		{LCM_SEND(2),{0x3F,0xFF}},
		{LCM_SEND(2),{0x40,0x06}},
		{LCM_SEND(2),{0x41,0xA0}},
		{LCM_SEND(2),{0x43,0x10}},
		{LCM_SEND(2),{0x44,0x0E}},
		{LCM_SEND(2),{0x45,0x3C}},
		{LCM_SEND(2),{0x55,0x01}},
		{LCM_SEND(2),{0x56,0x01}},
		{LCM_SEND(2),{0x57,0x64}},
		{LCM_SEND(2),{0x58,0x0A}},
		{LCM_SEND(2),{0x59,0x0A}},
		{LCM_SEND(2),{0x5A,0x28}},
		{LCM_SEND(2),{0x5B,0x10}},
		{LCM_SEND(2),{0x5D,0x7C}},
		{LCM_SEND(2),{0x5E,0x60}},
		{LCM_SEND(2),{0x5F,0x4E}},
		{LCM_SEND(2),{0x60,0x40}},
		{LCM_SEND(2),{0x61,0x39}},
		{LCM_SEND(2),{0x62,0x28}},
		{LCM_SEND(2),{0x63,0x2A}},
		{LCM_SEND(2),{0x64,0x11}},
		{LCM_SEND(2),{0x65,0x27}},
		{LCM_SEND(2),{0x66,0x23}},
		{LCM_SEND(2),{0x67,0x21}},
			{LCM_SEND(2),{0x68,0x3D}},
			{LCM_SEND(2),{0x69,0x2B}},
			{LCM_SEND(2),{0x6A,0x33}},
			{LCM_SEND(2),{0x6B,0x26}},
			{LCM_SEND(2),{0x6C,0x24}},
			{LCM_SEND(2),{0x6D,0x18}},
			{LCM_SEND(2),{0x6E,0x0A}},
			{LCM_SEND(2),{0x6F,0x00}},
			{LCM_SEND(2),{0x70,0x7C}},
			{LCM_SEND(2),{0x71,0x60}},
			{LCM_SEND(2),{0x72,0x4E}},
			{LCM_SEND(2),{0x73,0x40}},
			{LCM_SEND(2),{0x74,0x39}},
			{LCM_SEND(2),{0x75,0x29}},
			{LCM_SEND(2),{0x76,0x2B}},
			{LCM_SEND(2),{0x77,0x12}},
			{LCM_SEND(2),{0x78,0x27}},
			{LCM_SEND(2),{0x79,0x24}},
			{LCM_SEND(2),{0x7A,0x21}},
			{LCM_SEND(2),{0x7B,0x3E}},
			{LCM_SEND(2),{0x7C,0x2B}},
			{LCM_SEND(2),{0x7D,0x33}},
			{LCM_SEND(2),{0x7E,0x26}},
			{LCM_SEND(2),{0x71,0x60}},
			{LCM_SEND(2),{0x72,0x4E}},
			{LCM_SEND(2),{0x73,0x40}},			
			{LCM_SEND(2),{0x74,0x39}},
			{LCM_SEND(2),{0x7F,0x24}},
			//36
			{LCM_SEND(2),{0x80,0x19}},
//2B
{LCM_SEND(2),{0x81,0x0A}},
//1C
...
{LCM_SEND(2),{0x05,0x19}},
{LCM_SEND(2),{0x06,0x0A}},
{LCM_SEND(2),{0x07,0x1B}},
{LCM_SEND(2),{0x08,0x00}},
{LCM_SEND(2),{0x09,0x1D}},
{LCM_SEND(2),{0x0A,0x1F}},
{LCM_SEND(2),{0x0B,0x1F}},
{LCM_SEND(2),{0x0C,0x1D}},
{LCM_SEND(2),{0x0D,0x1D}},
{LCM_SEND(2),{0x0E,0x1D}},
{LCM_SEND(2),{0x0F,0x17}},
{LCM_SEND(2),{0x10,0x37}},
{LCM_SEND(2),{0x11,0x1D}},
{LCM_SEND(2),{0x12,0x1F}},
{LCM_SEND(2),{0x13,0x1E}},
{LCM_SEND(2),{0x14,0x10}},
{LCM_SEND(2),{0x15,0x1D}},

//GIP_R Pin mapping
{LCM_SEND(2),{0x16,0x0F}},
{LCM_SEND(2),{0x17,0x07}},
{LCM_SEND(2),{0x18,0x0D}},
{LCM_SEND(2),{0x19,0x05}},
{LCM_SEND(2),{0x1A,0x09}},
{LCM_SEND(2),{0x1B,0x1A}},
{LCM_SEND(2),{0x1C,0x0B}},
{LCM_SEND(2),{0x1D,0x1C}},
{LCM_SEND(2),{0x1E,0x01}},
{LCM_SEND(2),{0x1F,0x1D}},
{LCM_SEND(2),{0x20,0x1F}},
{LCM_SEND(2),{0x21,0x1F}},
{LCM_SEND(2),{0x22,0x1D}},
{LCM_SEND(2),{0x23,0x1D}},
{LCM_SEND(2),{0x24,0x1D}},
{LCM_SEND(2),{0x25,0x18}},
{LCM_SEND(2),{0x26,0x38}},
{LCM_SEND(2),{0x27,0x1D}},
{LCM_SEND(2),{0x28,0x1F}},
{LCM_SEND(2),{0x29,0x1E}},
{LCM_SEND(2),{0x2A,0x11}},
{LCM_SEND(2),{0x2B,0x1D}},

//GIP_L_GS Pin mapping
{LCM_SEND(2),{0x2C,0x09}},
{LCM_SEND(2),{0x2D,0x1A}},
{LCM_SEND(2),{0x2E,0x0B}},
{LCM_SEND(2),{0x2F,0x1C}},
{LCM_SEND(2),{0x30,0x0F}},
{LCM_SEND(2),{0x31,0x07}},
{LCM_SEND(2),{0x32,0x0D}},
{LCM_SEND(2),{0x33,0x05}},
{LCM_SEND(2),{0x34,0x11}},
{LCM_SEND(2),{0x35,0x1D}},
{LCM_SEND(2),{0x36,0x1F}},
{LCM_SEND(2),{0x37,0x1F}},
{LCM_SEND(2),{0x38,0x1D}},
{LCM_SEND(2),{0x39,0x1D}},
{LCM_SEND(2),{0x3A,0x1D}},
{LCM_SEND(2),{0x3B,0x18}},
{LCM_SEND(2),{0x3C,0x38}},
{LCM_SEND(2),{0x3D,0x1D}},
{LCM_SEND(2),{0x3E,0x1E}},
{LCM_SEND(2),{0x3F,0x1F}},
{LCM_SEND(2),{0x40,0x01}},
{LCM_SEND(2),{0x41,0x1D}},

//GIP_R_GS Pin mapping
{LCM_SEND(2),{0x42,0x08}},
{LCM_SEND(2),{0x43,0x19}},
{LCM_SEND(2),{0x44,0x0A}},
{LCM_SEND(2),{0x45,0x1B}},
{LCM_SEND(2),{0x46,0x0E}},
{LCM_SEND(2),{0x47,0x06}},
{LCM_SEND(2),{0x48,0x0C}},
{LCM_SEND(2),{0x49,0x04}},
{LCM_SEND(2),{0x4A,0x10}},
{LCM_SEND(2),{0x4B,0x1D}},
{LCM_SEND(2),{0x4C,0x1F}},
{LCM_SEND(2),{0x4D,0x1F}},
{LCM_SEND(2),{0x4E,0x1D}},
{LCM_SEND(2),{0x4F,0x1D}},
{LCM_SEND(2),{0x50,0x1D}},
{LCM_SEND(2),{0x51,0x17}},
{LCM_SEND(2),{0x52,0x37}},
{LCM_SEND(2),{0x53,0x1D}},
{LCM_SEND(2),{0x54,0x1E}},
{LCM_SEND(2),{0x55,0x1F}},
{LCM_SEND(2),{0x56,0x00}},
{LCM_SEND(2),{0x57,0x1D}},
//GIP Timing
...
{LCM_SEND(2),{0x5D,0xD0}},
{LCM_SEND(2),{0x5E,0x01}},
{LCM_SEND(2),{0x5F,0x02}},
{LCM_SEND(2),{0x60,0x60}},
...
{LCM_SEND(2),{0x67,0xF7}},
{LCM_SEND(2),{0x68,0x08}},
