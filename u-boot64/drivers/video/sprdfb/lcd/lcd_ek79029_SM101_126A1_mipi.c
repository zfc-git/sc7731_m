...
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x33,0x10}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x65,0x08}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x3A,0x02}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x36,0x48}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x67,0x82}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x69,0x20}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x6C,0x80}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x6D,0x15}},
{LCM_SLEEP(1),},
{LCM_SEND(11),{9,0,0x55,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06}},
{LCM_SLEEP(1),},
{LCM_SEND(19),{17,0,0x56,0x03,0x06,0x03,0x06,0x03,0x06,0x03,0x06,0x03,0x06,0x03,0x06,0x03,0x06,0x03,0x06}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x6B,0x00}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x58,0x00}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x73,0x30}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x74,0x10}},
{LCM_SLEEP(1),},
...
{LCM_SEND(2), {0x28,0xF1}},
{LCM_SLEEP(1),},
{LCM_SEND(11),{9,0,0x57,0x00,0x06,0x00,0x06,0x00,0x06,0x00,0x06}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x41,0x1D}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x4E,0x27}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x4F,0x2C}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x63,0x04}},
{LCM_SLEEP(1),},
{LCM_SEND(22),{20,0,0x53,0x1F,0x18,0x15,0x10,0x0f,0x0E,0x0F,0x10,0x11,0x0E,0x09,0x07,0x08,0x0A,0x0A,0x09,0x05,0x03,0x01}},
{LCM_SLEEP(1),},
{LCM_SEND(22),{20,0,0x54,0x1F,0x18,0x16,0x11,0x11,0x0F,0x10,0x13,0x13,0x10,0x0D,0x0C,0x0C,0x0F,0x0E,0x0F,0x0A,0x08,0x01}},
{LCM_SLEEP(1),},
{LCM_SEND(2), {0x29,0x14}},
{LCM_SLEEP(1),},
