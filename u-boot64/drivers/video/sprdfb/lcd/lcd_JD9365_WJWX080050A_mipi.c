...
{LCM_SEND(2),{0x18,0xF2}},	//VGMP=4.8V
{LCM_SEND(2),{0x19,0x00}},
{LCM_SEND(2),{0x1A,0x00}},
{LCM_SEND(2),{0x1B,0xF2}},  //VGMN=-4.8V
{LCM_SEND(2),{0x1C,0x00}},
                
//Set Gate Power
{LCM_SEND(2),{0x1F,0x7E}},	//VGH_REG=18V
{LCM_SEND(2),{0x20,0x24}},	//VGL_REG=-12V
{LCM_SEND(2),{0x21,0x24}},	//VGL_REG2=-12V
{LCM_SEND(2),{0x22,0x0E}},  //PA[6]=0, PA[5]=0, PA[4]=0, PA[0]=0 
                  
//{LCM_SEND(2),{0x24,0xF8}},     //AVDD_EN=0,AVEE_EN=0,        888
//{LCM_SEND(2),{0x26,0xD3}},     //GAS_EN,VCOM_EN,VGM_EN,      888
...
{LCM_SEND(2),{0x57,0x65}},	//[7:5]VGH_RT,[4:2]=VGL_RT,[1:0]=VCL_RT
{LCM_SEND(2),{0x58,0x08}},	//AVDD_S
{LCM_SEND(2),{0x59,0x28}},	//VCL = -2.7V
{LCM_SEND(2),{0x5A,0x2B}},	//VGH = 19V
{LCM_SEND(2),{0x5B,0x13}},	//VGL = -12V


//--- Gamma  ----//
{LCM_SEND(2),{0x5D,0x70}},
{LCM_SEND(2),{0x5E,0x5E}},
{LCM_SEND(2),{0x5F,0x50}},
{LCM_SEND(2),{0x60,0x45}},
{LCM_SEND(2),{0x61,0x42}},
{LCM_SEND(2),{0x62,0x33}},
{LCM_SEND(2),{0x63,0x37}},
{LCM_SEND(2),{0x64,0x21}},
{LCM_SEND(2),{0x65,0x39}},
{LCM_SEND(2),{0x66,0x36}},
{LCM_SEND(2),{0x67,0x36}},
{LCM_SEND(2),{0x68,0x54}},
{LCM_SEND(2),{0x69,0x41}},
{LCM_SEND(2),{0x6A,0x4A}},
{LCM_SEND(2),{0x6B,0x3D}},
{LCM_SEND(2),{0x6C,0x3A}},
{LCM_SEND(2),{0x6D,0x2F}},
{LCM_SEND(2),{0x6E,0x1F}},
{LCM_SEND(2),{0x6F,0x02}},
{LCM_SEND(2),{0x70,0x70}},
{LCM_SEND(2),{0x71,0x5E}},
{LCM_SEND(2),{0x72,0x50}},
{LCM_SEND(2),{0x73,0x45}},
{LCM_SEND(2),{0x74,0x42}},
{LCM_SEND(2),{0x75,0x33}},
{LCM_SEND(2),{0x76,0x37}},
{LCM_SEND(2),{0x77,0x21}},
{LCM_SEND(2),{0x78,0x39}},
{LCM_SEND(2),{0x79,0x36}},
{LCM_SEND(2),{0x7A,0x36}},
{LCM_SEND(2),{0x7B,0x54}},
{LCM_SEND(2),{0x7C,0x41}},
{LCM_SEND(2),{0x7D,0x4A}},
{LCM_SEND(2),{0x7E,0x3D}},
{LCM_SEND(2),{0x7F,0x3A}},
{LCM_SEND(2),{0x80,0x2F}},
...
{LCM_SEND(2),{0x02,0x17}},
{LCM_SEND(2),{0x03,0x37}},
{LCM_SEND(2),{0x04,0x08}},
{LCM_SEND(2),{0x05,0x0A}},
...
{LCM_SEND(2),{0x18,0x17}},
{LCM_SEND(2),{0x19,0x37}},
{LCM_SEND(2),{0x1A,0x09}},
{LCM_SEND(2),{0x1B,0x0B}},
{LCM_SEND(2),{0x1C,0x05}},
{LCM_SEND(2),{0x1D,0x07}},
