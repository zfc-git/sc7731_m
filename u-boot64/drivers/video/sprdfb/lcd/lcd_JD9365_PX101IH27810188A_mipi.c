...
{LCM_SEND(2),{0x2D,0x03}},//cfg_lane=1
...
{LCM_SEND(2),{0x01,0x5A}},  //55,66,5E,5A
//Set VCOM_Reverse
{LCM_SEND(2),{0x03,0x00}},
{LCM_SEND(2),{0x04,0x58}},

//Set Gamma Power, VGMP,VGMN,VGSP,VGSN
{LCM_SEND(2),{0x17,0x00}},
{LCM_SEND(2),{0x18,0xEF}},	//VGMP=5.1V
{LCM_SEND(2),{0x19,0x01}},	//VGSP=0.03V
{LCM_SEND(2),{0x1A,0x00}},
{LCM_SEND(2),{0x1B,0xEF}},  //VGMN=-5.1V
{LCM_SEND(2),{0x1C,0x01}},	//VGSN=-0.03V
                
//Set Gate Power
{LCM_SEND(2),{0x1F,0x7A}},//19.2V
{LCM_SEND(2),{0x20,0x24}}, //VGL_REG=-10V	
{LCM_SEND(2),{0x21,0x24}},
{LCM_SEND(2),{0x22,0x4E}},// VGH_REG=VGH
                  
//{LCM_SEND(2),{0x24,0xF8}},     //AVDD_EN=0,AVEE_EN=0
//{LCM_SEND(2),{0x26,0xD3}},     //GAS_EN,VCOM_EN,VGM_EN

//SetPanel
{LCM_SEND(2),{0x37,0x59}},	//SS=1,BGR=1

{LCM_SEND(2),{0x35,0x2C}},	//SAP,0x24

//SET RGBCYC
{LCM_SEND(2),{0x38,0x05}},	//JDT=100 column inversion
{LCM_SEND(2),{0x39,0x08}},	//RGB_N_EQ1
{LCM_SEND(2),{0x3A,0x10}},	//RGB_N_EQ2
{LCM_SEND(2),{0x3C,0x88}},	//SET EQ3 for TE_H,  0x7E
{LCM_SEND(2),{0x3D,0xFF}},
{LCM_SEND(2),{0x3E,0xFF}},	//SET CHGEN_OFF 
{LCM_SEND(2),{0x3F,0x7F}},	//SET CHGEN_OFF2


//Set TCON
{LCM_SEND(2),{0x40,0x06}},	//RSO=800 RGB
{LCM_SEND(2),{0x41,0xA0}},	//LN=640->1280 line
{LCM_SEND(2),{0x43,0x14}},	//VFP
{LCM_SEND(2),{0x44,0x0F}},	//VBP
{LCM_SEND(2),{0x45,0x24}},	//HBP

//{LCM_SEND(2),{0x4A,0x80}},	//BIST, for BIST enable=0xB0, diable=0x80

//--- power voltage  ----//
{LCM_SEND(2),{0x55,0x01}},	//01£ºJD5002;DCDCM=1111, no output
{LCM_SEND(2),{0x56,0x01}},
{LCM_SEND(2),{0x57,0x89}},
{LCM_SEND(2),{0x58,0x0A}},
{LCM_SEND(2),{0x59,0x0A}},	//VCL = -2.5V
{LCM_SEND(2),{0x5A,0x39}},	//VGH = 18.4V ,0x2D_VGH = 16V 
{LCM_SEND(2),{0x5B,0x10}},	//VGL = -10.2V
{LCM_SEND(2),{0x5C,0x16}},	//

//--- Gamma  ----//
{LCM_SEND(2),{0x5D,0x7A}},//0x7A//0x5E
{LCM_SEND(2),{0x5E,0x65}},//0x63//0x50
{LCM_SEND(2),{0x5F,0x56}},//0x52//0x44
{LCM_SEND(2),{0x60,0x49}},//0x45//0x3A
{LCM_SEND(2),{0x61,0x43}},//0x40//0x39
{LCM_SEND(2),{0x62,0x33}},//0x31//0x2B
{LCM_SEND(2),{0x63,0x35}},//0x33//0x31
{LCM_SEND(2),{0x64,0x1C}},//0x1C//0x1A
{LCM_SEND(2),{0x65,0x33}},//0x33//0x33
{LCM_SEND(2),{0x66,0x30}},//0x30//0x30
{LCM_SEND(2),{0x67,0x2E}},//0x2E//0x2D
{LCM_SEND(2),{0x68,0x4A}},//0x49//0x49
{LCM_SEND(2),{0x69,0x36}},//0x36//0x35
{LCM_SEND(2),{0x6A,0x3D}},//0x3D//0x3C
{LCM_SEND(2),{0x6B,0x2F}},//0x31//0x2E
{LCM_SEND(2),{0x6C,0x2D}},//0x31//0x2B
{LCM_SEND(2),{0x6D,0x23}},//0x29//0x20
{LCM_SEND(2),{0x6E,0x15}},//0x23//0x12
{LCM_SEND(2),{0x6F,0x04}},//0x20//0x02
{LCM_SEND(2),{0x70,0x7A}},//0x7A//0x5E
{LCM_SEND(2),{0x71,0x65}},//0x63//0x50
{LCM_SEND(2),{0x72,0x56}},//0x52//0x44
{LCM_SEND(2),{0x73,0x49}},//0x45//0x3A
{LCM_SEND(2),{0x74,0x43}},//0x40//0x39
{LCM_SEND(2),{0x75,0x33}},//0x31//0x2B
{LCM_SEND(2),{0x76,0x35}},//0x33//0x31
{LCM_SEND(2),{0x77,0x1C}},//0x1C//0x1A
{LCM_SEND(2),{0x78,0x33}},//0x33//0x33
{LCM_SEND(2),{0x79,0x30}},//0x30//0x30
{LCM_SEND(2),{0x7A,0x2E}},//0x2E//0x2D
{LCM_SEND(2),{0x7B,0x4A}},//0x49//0x49
{LCM_SEND(2),{0x7C,0x36}},//0x36//0x35
{LCM_SEND(2),{0x7D,0x3D}},//0x3D//0x3C
{LCM_SEND(2),{0x7E,0x2F}},//0x31//0x2E
{LCM_SEND(2),{0x7F,0x2D}},//0x31//0x2B
{LCM_SEND(2),{0x80,0x23}},//0x29//0x20
{LCM_SEND(2),{0x81,0x15}},//0x23//0x12
{LCM_SEND(2),{0x82,0x04}},//0x20//0x02
...
//GIP_L Pin mapping
{LCM_SEND(2),{0x00,0x1E}},
{LCM_SEND(2),{0x01,0x1F}},
{LCM_SEND(2),{0x02,0x57}},
{LCM_SEND(2),{0x03,0x58}},
{LCM_SEND(2),{0x04,0x48}},
{LCM_SEND(2),{0x05,0x4A}},
{LCM_SEND(2),{0x06,0x44}},
{LCM_SEND(2),{0x07,0x46}},
{LCM_SEND(2),{0x08,0x40}},
...
//GIP_R Pin mapping
{LCM_SEND(2),{0x16,0x1E}},
{LCM_SEND(2),{0x17,0x1F}},
{LCM_SEND(2),{0x18,0x57}},
{LCM_SEND(2),{0x19,0x58}},
{LCM_SEND(2),{0x1A,0x49}},
{LCM_SEND(2),{0x1B,0x4B}},
{LCM_SEND(2),{0x1C,0x45}},
{LCM_SEND(2),{0x1D,0x47}},
{LCM_SEND(2),{0x1E,0x41}},
...
{LCM_SEND(2),{0x2C,0x1F}},
{LCM_SEND(2),{0x2D,0x1E}},   
{LCM_SEND(2),{0x2E,0x17}}, 
{LCM_SEND(2),{0x2F,0x18}}, 
{LCM_SEND(2),{0x30,0x07}}, 
{LCM_SEND(2),{0x31,0x05}}, 
{LCM_SEND(2),{0x32,0x0B}}, 
{LCM_SEND(2),{0x33,0x09}}, 
...
{LCM_SEND(2),{0x42,0x1F}},
{LCM_SEND(2),{0x43,0x1E}},   
{LCM_SEND(2),{0x44,0x17}}, 
{LCM_SEND(2),{0x45,0x18}}, 
{LCM_SEND(2),{0x46,0x06}}, 
{LCM_SEND(2),{0x47,0x04}}, 
{LCM_SEND(2),{0x48,0x0A}}, 
{LCM_SEND(2),{0x49,0x08}}, 
{LCM_SEND(2),{0x4A,0x02}}, 
...
{LCM_SEND(2),{0x5E,0x01}}, //0x00 
{LCM_SEND(2),{0x5F,0x02}}, //0x00 
{LCM_SEND(2),{0x60,0x30}}, 
{LCM_SEND(2),{0x61,0x03}}, 
{LCM_SEND(2),{0x62,0x04}}, 
{LCM_SEND(2),{0x63,0x6A}}, //03
{LCM_SEND(2),{0x64,0x6A}}, //SETV_OFF, modify 20140806
{LCM_SEND(2),{0x65,0x75}}, 
{LCM_SEND(2),{0x66,0x0D}}, 
{LCM_SEND(2),{0x67,0x73}}, 
{LCM_SEND(2),{0x68,0x09}}, 
{LCM_SEND(2),{0x69,0x6A}}, //06
{LCM_SEND(2),{0x6A,0x6A}}, //CKV_OFF, modify 20140806 
{LCM_SEND(2),{0x6B,0x08}}, //0x04
{LCM_SEND(2),{0x6C,0x00}}, 
{LCM_SEND(2),{0x6D,0x04}}, //0x0C
{LCM_SEND(2),{0x6E,0x00}}, //00
...
{LCM_SEND(2),{0x75,0xBC}}, //80
{LCM_SEND(2),{0x76,0x00}}, 
{LCM_SEND(2),{0x77,0x0D}}, 
{LCM_SEND(2),{0x78,0x23}}, //24
