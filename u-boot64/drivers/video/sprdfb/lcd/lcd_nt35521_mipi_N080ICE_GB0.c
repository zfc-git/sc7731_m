...
{LCM_SEND(5),{3,0,0xB3,0x37,0x37}},
{LCM_SEND(5),{3,0,0xB4,0x19,0x19}},
{LCM_SEND(5),{3,0,0xB9,0x44,0x44}},
{LCM_SEND(5),{3,0,0xBA,0x24,0x24}},
//==========page2relative==========}},
{LCM_SEND(8),{6,0,0xF0,0x55,0xAA,0x52,0x08,0x02}},
{LCM_SEND(2),{0xEE,0x02}},
{LCM_SEND(7),{5,0,0xEF,0x09,0x06,0x15,0x18}},
{LCM_SEND(9),{7,0,0xB0,0x00,0x00,0x00,0x19,0x00,0x31}},
{LCM_SEND(2),{0x6F,0x06}},
{LCM_SEND(9),{7,0,0xB0,0x00,0x4B,0x00,0x63,0x00,0x95}},
{LCM_SEND(2),{0x6F,0x0C}},
{LCM_SEND(7),{5,0,0xB0,0x00,0xB4,0x00,0xF3}},
{LCM_SEND(9),{7,0,0xB1,0x01,0x24,0x01,0x70,0x01,0xA6}},
{LCM_SEND(2),{0x6F,0x06}},
{LCM_SEND(9),{7,0,0xB1,0x01,0xFC,0x02,0x49,0x02,0x4C}},
{LCM_SEND(2),{0x6F,0x0C}},
{LCM_SEND(7),{5,0,0xB1,0x02,0x96,0x02,0xEC}},
{LCM_SEND(9),{7,0,0xB2,0x03,0x1D,0x03,0x5A,0x03,0x81}},
{LCM_SEND(2),{0x6F,0x06}},
{LCM_SEND(9),{7,0,0xB2,0x03,0xA2,0x03,0xB6,0x03,0xCB}},
{LCM_SEND(2),{0x6F,0x0C}},
{LCM_SEND(7),{5,0,0xB2,0x03,0xD9,0x03,0xE8}},
{LCM_SEND(7),{5,0,0xB3,0x03,0xF7,0x03,0xFF}},
{LCM_SEND(9),{7,0,0xBC,0x00,0x00,0x00,0x19,0x00,0x31}},
{LCM_SEND(2),{0x6F,0x06}},
{LCM_SEND(9),{7,0,0xBC,0x00,0x4B,0x00,0x63,0x00,0x95}},
{LCM_SEND(2),{0x6F,0x0C}},
{LCM_SEND(7),{5,0,0xBC,0x00,0xB4,0x00,0xF3}},
{LCM_SEND(9),{7,0,0xBD,0x01,0x24,0x01,0x70,0x01,0xA6}},
{LCM_SEND(2),{0x6F,0x06}},
{LCM_SEND(9),{7,0,0xBD,0x01,0xFC,0x02,0x49,0x02,0x4C}},
{LCM_SEND(2),{0x6F,0x0C}},
{LCM_SEND(7),{5,0,0xBD,0x02,0x96,0x02,0xEC}},
{LCM_SEND(9),{7,0,0xBE,0x03,0x1D,0x03,0x5A,0x03,0x81}},
{LCM_SEND(2),{0x6F,0x06}},
{LCM_SEND(9),{7,0,0xBE,0x03,0xA2,0x03,0xB6,0x03,0xCB}},
{LCM_SEND(2),{0x6F,0x0C}},
{LCM_SEND(7),{5,0,0xBE,0x03,0xD9,0x03,0xE8}},
{LCM_SEND(7),{5,0,0xBF,0x03,0xF7,0x03,0xFF}},
//PAGE6:GOUTMapping,VGLOselect}},
{LCM_SEND(8),{6,0,0xF0,0x55,0xAA,0x52,0x08,0x06}},
{LCM_SEND(5),{3,0,0xB0,0x00,0x10}},
{LCM_SEND(5),{3,0,0xB1,0x12,0x14}},
{LCM_SEND(5),{3,0,0xB2,0x16,0x18}},
{LCM_SEND(5),{3,0,0xB3,0x1A,0x29}},
{LCM_SEND(5),{3,0,0xB4,0x2A,0x08}},
{LCM_SEND(5),{3,0,0xB5,0x31,0x31}},
{LCM_SEND(5),{3,0,0xB6,0x31,0x31}},
{LCM_SEND(5),{3,0,0xB7,0x31,0x31}},
{LCM_SEND(5),{3,0,0xB8,0x31,0x0A}},
{LCM_SEND(5),{3,0,0xB9,0x31,0x31}},
{LCM_SEND(5),{3,0,0xBA,0x31,0x31}},
{LCM_SEND(5),{3,0,0xBB,0x0B,0x31}},
{LCM_SEND(5),{3,0,0xBC,0x31,0x31}},
{LCM_SEND(5),{3,0,0xBD,0x31,0x31}},
{LCM_SEND(5),{3,0,0xBE,0x31,0x31}},
{LCM_SEND(5),{3,0,0xBF,0x09,0x2A}},
{LCM_SEND(5),{3,0,0xC0,0x29,0x1B}},
{LCM_SEND(5),{3,0,0xC1,0x19,0x17}},
{LCM_SEND(5),{3,0,0xC2,0x15,0x13}},
{LCM_SEND(5),{3,0,0xC3,0x11,0x01}},
{LCM_SEND(5),{3,0,0xE5,0x31,0x31}},
{LCM_SEND(5),{3,0,0xC4,0x09,0x1B}},
{LCM_SEND(5),{3,0,0xC5,0x19,0x17}},
{LCM_SEND(5),{3,0,0xC6,0x15,0x13}},
{LCM_SEND(5),{3,0,0xC7,0x11,0x29}},
{LCM_SEND(5),{3,0,0xC8,0x2A,0x01}},
{LCM_SEND(5),{3,0,0xC9,0x31,0x31}},
{LCM_SEND(5),{3,0,0xCA,0x31,0x31}},
{LCM_SEND(5),{3,0,0xCB,0x31,0x31}},
{LCM_SEND(5),{3,0,0xCC,0x31,0x0B}},
{LCM_SEND(5),{3,0,0xCD,0x31,0x31}},
{LCM_SEND(5),{3,0,0xCE,0x31,0x31}},
{LCM_SEND(5),{3,0,0xCF,0x0A,0x31}},
{LCM_SEND(5),{3,0,0xD0,0x31,0x31}},
{LCM_SEND(5),{3,0,0xD1,0x31,0x31}},
{LCM_SEND(5),{3,0,0xD2,0x31,0x31}},
{LCM_SEND(5),{3,0,0xD3,0x00,0x2A}},
{LCM_SEND(5),{3,0,0xD4,0x29,0x10}},
{LCM_SEND(5),{3,0,0xD5,0x12,0x14}},
{LCM_SEND(5),{3,0,0xD6,0x16,0x18}},
{LCM_SEND(5),{3,0,0xD7,0x1A,0x08}},
{LCM_SEND(5),{3,0,0xE6,0x31,0x31}},
{LCM_SEND(8),{6,0,0xD8,0x00,0x00,0x00,0x54,0x00}},
{LCM_SEND(8),{6,0,0xD9,0x00,0x15,0x00,0x00,0x00}},
...
{LCM_SEND(8),{6,0,0xD1,0x00,0x04,0xFD,0x07,0x10}},
{LCM_SEND(8),{6,0,0xD2,0x00,0x05,0x02,0x07,0x10}},
