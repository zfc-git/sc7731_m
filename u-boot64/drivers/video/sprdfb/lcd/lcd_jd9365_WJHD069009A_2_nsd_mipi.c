...
{LCM_SEND(2),{0x80,0x03}},//03:4-Lane;02:3-Lane
...
{LCM_SEND(2),{0x01,0xca}}, //VCOM  //CF CC //bc
{LCM_SEND(2),{0x03,0x00}},
{LCM_SEND(2),{0x04,0xca}}, //VCOM  //CF CC //bc
...
{LCM_SEND(2),{0x45,0x30}},

//--- power voltage  ----//
{LCM_SEND(2),{0x55,0x02}},	//DCDCM=0011, PWR_IC=FP7721=0x02
{LCM_SEND(2),{0x56,0x01}},
{LCM_SEND(2),{0x57,0x69}},
{LCM_SEND(2),{0x58,0x0A}},
{LCM_SEND(2),{0x59,0x0A}},	//VCL = -2.9V
{LCM_SEND(2),{0x5A,0x2A}},	//VGH = 15.4V  0x2A
{LCM_SEND(2),{0x5B,0x16}},  //VGL = -11.4V 0x16
{LCM_SEND(2),{0x5C,0x16}},


//--- Gamma  ----//
{LCM_SEND(2),{0x5D,0x7C}},	//70
{LCM_SEND(2),{0x5E,0x5F}},  //56
{LCM_SEND(2),{0x5F,0x4D}},	//45
{LCM_SEND(2),{0x60,0x3F}},	//39
{LCM_SEND(2),{0x61,0x39}},  //35
{LCM_SEND(2),{0x62,0x29}},  //26
{LCM_SEND(2),{0x63,0x2B}},  //2A
{LCM_SEND(2),{0x64,0x12}},  //14
{LCM_SEND(2),{0x65,0x28}},  //2E
{LCM_SEND(2),{0x66,0x24}},  //2D
{LCM_SEND(2),{0x67,0x22}},  //2D
{LCM_SEND(2),{0x68,0x3E}},  //4C
{LCM_SEND(2),{0x69,0x2C}},  //3A
{LCM_SEND(2),{0x6A,0x33}},  //45
{LCM_SEND(2),{0x6B,0x26}},  //38
{LCM_SEND(2),{0x6C,0x23}},  //36
{LCM_SEND(2),{0x6D,0x18}},  //2B
{LCM_SEND(2),{0x6E,0x09}},  //1C
{LCM_SEND(2),{0x6F,0x00}},  //00

{LCM_SEND(2),{0x70,0x7C}},  //70
{LCM_SEND(2),{0x71,0x5F}},  //56
{LCM_SEND(2),{0x72,0x4D}},  //45
{LCM_SEND(2),{0x73,0x3F}},  //39
{LCM_SEND(2),{0x74,0x39}},  //35
{LCM_SEND(2),{0x75,0x29}},  //26
{LCM_SEND(2),{0x76,0x2B}},  //2A
{LCM_SEND(2),{0x77,0x12}},  //14
{LCM_SEND(2),{0x78,0x28}},  //2E
{LCM_SEND(2),{0x79,0x24}},  //2D
{LCM_SEND(2),{0x7A,0x22}},  //2D
{LCM_SEND(2),{0x7B,0x3E}},  //4C
{LCM_SEND(2),{0x7C,0x2C}},  //3A
{LCM_SEND(2),{0x7D,0x33}},  //45
{LCM_SEND(2),{0x7E,0x26}},  //38
{LCM_SEND(2),{0x7F,0x23}},  //36
{LCM_SEND(2),{0x80,0x18}},  //2B
{LCM_SEND(2),{0x81,0x09}},  //1C
{LCM_SEND(2),{0x82,0x00}},  //00

//Page2, for GIP
{LCM_SEND(2),{0xE0,0x02}},
//GIP_L Pin mapping
{LCM_SEND(2),{0x00,0x77}},
{LCM_SEND(2),{0x01,0x57}},
{LCM_SEND(2),{0x02,0x4A}},
{LCM_SEND(2),{0x03,0x46}},
{LCM_SEND(2),{0x04,0x48}},
{LCM_SEND(2),{0x05,0x44}},
{LCM_SEND(2),{0x06,0x40}},
...
{LCM_SEND(2),{0x14,0x50}},
{LCM_SEND(2),{0x15,0x1F}},

//GIP_R Pin mapping
{LCM_SEND(2),{0x16,0x77}},
{LCM_SEND(2),{0x17,0x57}},
{LCM_SEND(2),{0x18,0x4B}},
{LCM_SEND(2),{0x19,0x47}},
{LCM_SEND(2),{0x1A,0x49}},
{LCM_SEND(2),{0x1B,0x45}},
{LCM_SEND(2),{0x1C,0x41}},
...
static void lcd_reset_en(unsigned char en)
{
	sprd_gpio_request(NULL,103);
	if(en)
	{
		sprd_gpio_direction_output(NULL,103, 1);	
	}
	else
	{
...
static void lcd_power_en(unsigned char enabled)
{
	...
	if(enabled)
	{
		sprd_gpio_direction_output(NULL,233, 1);	
	}
	else
	{
...
static void lcd_avdd_en(unsigned char enabled)
{
	...
	if(enabled)
	{
		sprd_gpio_direction_output(NULL,232, 1);	
	}
	else
	{
