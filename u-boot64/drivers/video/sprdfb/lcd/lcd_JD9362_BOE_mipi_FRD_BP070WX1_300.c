...
{LCM_SEND(2),{0x01,0xA9}},	//VCOM A8 AE AD
//Set VCOM_Reverse
{LCM_SEND(2),{0x03,0x00}},
{LCM_SEND(2),{0x04,0xA8}},	

//Set Gamma Power, VGMP,VGMN,VGSP,VGSN
{LCM_SEND(2),{0x17,0x00}},
{LCM_SEND(2),{0x18,0xB1}},
{LCM_SEND(2),{0x19,0x01}},
{LCM_SEND(2),{0x1A,0x00}},
{LCM_SEND(2),{0x1B,0xB1}},  //VGMN=0
{LCM_SEND(2),{0x1C,0x01}},
                
//Set Gate Power
{LCM_SEND(2),{0x1F,0x3E}},     //VGH_R  = 15V                       
{LCM_SEND(2),{0x20,0x2D}},     //VGL_R  = -12V                      
{LCM_SEND(2),{0x21,0x2D}},     //VGL_R2 = -12V                      
{LCM_SEND(2),{0x22,0x7E}},     //PA[6]=0, PA[5]=0, PA[4]=0, PA[0]=0 

//SETPANEL
{LCM_SEND(2),{0x37,0x19}},	//SS=1,BGR=1

//SET RGBCYC
{LCM_SEND(2),{0x38,0x05}},	//JDT=101 zigzag inversion
{LCM_SEND(2),{0x39,0x00}},	//RGB_N_EQ1, modify 20140806
{LCM_SEND(2),{0x3A,0x01}},	//RGB_N_EQ2, modify 20140806
{LCM_SEND(2),{0x3C,0x78}},	//SET EQ3 for TE_H
{LCM_SEND(2),{0x3D,0xFF}},	//SET CHGEN_OFF, modify 20140827 
{LCM_SEND(2),{0x3E,0xFF}},	//SET CHGEN_OFF, modify 20140827 
{LCM_SEND(2),{0x3F,0xFF}},	//SET CHGEN_OFF2, modify 20140827
//{LCM_SEND(2),{0x3E,0x80}},	//SET CHGEN_OFF, modify 20140806 
//{LCM_SEND(2),{0x3F,0x80}},	//SET CHGEN_OFF2, modify 20140806
...
{LCM_SEND(2),{0x43,0x08}},
{LCM_SEND(2),{0x44,0x09}},
{LCM_SEND(2),{0x45,0x28}},

//--- power voltage  ----//
{LCM_SEND(2),{0x55,0x0F}},	//DCDCM=1111
//{LCM_SEND(2),{0x56,0x01}},
{LCM_SEND(2),{0x57,0x89}},	//VGH_RT=100, Charge pump Ratio:3*AVDD-VCL
{LCM_SEND(2),{0x58,0x0A}},
{LCM_SEND(2),{0x59,0x0A}},	//VCL = -2.5V
{LCM_SEND(2),{0x5A,0x28}},	//VGH = 15V
{LCM_SEND(2),{0x5B,0x19}},	//VGL = -12V



//--- Gamma  ----//
{LCM_SEND(2),{0x5D,0x7C}}, // 
{LCM_SEND(2),{0x5E,0x66}}, //
{LCM_SEND(2),{0x5F,0x56}}, //
{LCM_SEND(2),{0x60,0x49}}, //
{LCM_SEND(2),{0x61,0x44}}, //
{LCM_SEND(2),{0x62,0x34}}, //
{LCM_SEND(2),{0x63,0x37}}, //
{LCM_SEND(2),{0x64,0x1F}}, //
{LCM_SEND(2),{0x65,0x36}}, //
{LCM_SEND(2),{0x66,0x33}}, //
{LCM_SEND(2),{0x67,0x32}}, //
{LCM_SEND(2),{0x68,0x4F}}, //
{LCM_SEND(2),{0x69,0x3D}}, //
{LCM_SEND(2),{0x6A,0x43}}, //
{LCM_SEND(2),{0x6B,0x35}}, //
{LCM_SEND(2),{0x6C,0x30}}, //
{LCM_SEND(2),{0x6D,0x24}}, //
{LCM_SEND(2),{0x6E,0x13}}, //
{LCM_SEND(2),{0x6F,0x00}}, //
{LCM_SEND(2),{0x70,0x7C}}, //
{LCM_SEND(2),{0x71,0x66}}, //
{LCM_SEND(2),{0x72,0x56}}, //
{LCM_SEND(2),{0x73,0x49}}, //
{LCM_SEND(2),{0x74,0x44}}, //
{LCM_SEND(2),{0x75,0x34}}, //
{LCM_SEND(2),{0x76,0x37}}, //
{LCM_SEND(2),{0x77,0x1F}}, //
{LCM_SEND(2),{0x78,0x36}}, //
{LCM_SEND(2),{0x79,0x33}}, //
{LCM_SEND(2),{0x7A,0x32}}, //
{LCM_SEND(2),{0x7B,0x4F}}, //
{LCM_SEND(2),{0x7C,0x3D}}, //
{LCM_SEND(2),{0x7D,0x43}}, //
{LCM_SEND(2),{0x7E,0x35}}, //
{LCM_SEND(2),{0x7F,0x30}}, //
{LCM_SEND(2),{0x80,0x24}}, //
{LCM_SEND(2),{0x81,0x13}}, //
...
//GIP_L Pin mapping
{LCM_SEND(2),{0x00,0x45}},//0x05
{LCM_SEND(2),{0x01,0x45}},//0x05  
{LCM_SEND(2),{0x02,0x44}},//0x04
{LCM_SEND(2),{0x03,0x44}},//0x04
{LCM_SEND(2),{0x04,0x47}},//0x07
{LCM_SEND(2),{0x05,0x47}},//0x07
{LCM_SEND(2),{0x06,0x46}},//0x06
{LCM_SEND(2),{0x07,0x46}},//0x06
{LCM_SEND(2),{0x08,0x40}},//0x00
{LCM_SEND(2),{0x09,0x1F}},//0x1F
{LCM_SEND(2),{0x0A,0x1F}},//0x1F
{LCM_SEND(2),{0x0B,0x1F}},//0x1F
{LCM_SEND(2),{0x0C,0x1F}},//0x1F
{LCM_SEND(2),{0x0D,0x1F}},//0x1F
{LCM_SEND(2),{0x0E,0x1F}},//0x1F
{LCM_SEND(2),{0x0F,0x41}},//0x01
{LCM_SEND(2),{0x10,0x1F}},//0x1F
{LCM_SEND(2),{0x11,0x1F}},//0x1F
{LCM_SEND(2),{0x12,0x1F}},//0x1F
{LCM_SEND(2),{0x13,0x1F}},//0x1F
{LCM_SEND(2),{0x14,0x1F}},//0x1F
{LCM_SEND(2),{0x15,0x1F}},//0x1F

//GIP_R Pin mapping
{LCM_SEND(2),{0x16,0x45}},
{LCM_SEND(2),{0x17,0x45}},
{LCM_SEND(2),{0x18,0x44}},
{LCM_SEND(2),{0x19,0x44}},
{LCM_SEND(2),{0x1A,0x47}},
{LCM_SEND(2),{0x1B,0x47}},
{LCM_SEND(2),{0x1C,0x46}},
{LCM_SEND(2),{0x1D,0x46}},
...
//GIP Timing  
{LCM_SEND(2),{0x58,0x40}},        // TGEQL, Initial porch
//{LCM_SEND(2),{0x59,0x00}},
//{LCM_SEND(2),{0x5A,0x00}},
{LCM_SEND(2),{0x5B,0x10}},       //STV number =4, STV_S0[10:8]
{LCM_SEND(2),{0x5C,0x06}},       //STV_S0[7:0] =
{LCM_SEND(2),{0x5D,0x20}},//60   //STV_W=4 , STV_S1=0,1h timing
{LCM_SEND(2),{0x5E,0x01}},       //STV_S2 =1,1h timing
{LCM_SEND(2),{0x5F,0x02}},       //STV_S3 =2,1h timing
//{LCM_SEND(2),{0x60,0x00}},     //ETV default
//{LCM_SEND(2),{0x61,0x01}},     //ETV default
//{LCM_SEND(2),{0x62,0x02}},     //ETV default
{LCM_SEND(2),{0x63,0x62}},       //SETV_ON
{LCM_SEND(2),{0x64,0x62}},       //SETV_OFF
//{LCM_SEND(2),{0x65,0x00}},    //ETV
//{LCM_SEND(2),{0x66,0x00}},    //ETV
{LCM_SEND(2),{0x67,0x32}},          //CKV0_NUM[3:0]=8, CKV0_W[3:0]=4
{LCM_SEND(2),{0x68,0x08}},   //0x06       
{LCM_SEND(2),{0x69,0x62}}, 
{LCM_SEND(2),{0x6A,0x66}}, //66 CLK Falling to Source Falling time 3us
...
{LCM_SEND(2),{0x98,0x3E}},	//From 2E to 3E, LED_ON


//Page4
{LCM_SEND(2),{0xE0,0x04}},  //ESD protect
...
//Page0
{LCM_SEND(2),{0xE0,0x00}}, //Watch dog
