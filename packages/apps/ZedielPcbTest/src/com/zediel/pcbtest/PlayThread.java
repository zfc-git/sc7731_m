...
public class PlayThread extends Thread {
    ...
    public PlayThread(Activity activity, int fileName) {
        mActivity = activity;
        mFileName = fileName;
    ...
    public void run() {
        ...
        try {
            ...
            InputStream inputStream = mActivity.getResources().openRawResource(mFileName); //getResources().openRawResource    .getResources().getAssets()
