...
class AllAppsList {
	...
	private List<String> hideappList = new ArrayList();
	...
	/*add the method by szh to hide the app you want!*/
    public void addHideappList(){
         //hideappList.add("com.google.android.gms");
		 hideappList.add("com.android.sprd.flashtest");//add the package name which you want to hide it.
    }
