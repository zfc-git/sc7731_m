...
public class DeviceProfile {
    ...
    public void updateAppsViewNumCols(Resources res, int recyclerViewWidth) {
		...
		//set max columns by lxj
		if(isLandscape) {
			allAppsNumCols = allAppsNumPredictiveCols 
				= res.getInteger(R.integer.config_apps_landlandscape_colums);

		}else {
			allAppsNumCols = allAppsNumPredictiveCols 
				= res.getInteger(R.integer.config_apps_portrait_colums);
		}
		//end lxj
    }
