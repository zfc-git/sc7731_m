...
public class FmUtils {
    ...
    public static String getDefaultStoragePath() {
        /**
         * SPRD: bug474747, recording path selection. & bug529776 Check the main card state,change get internal storage path method.
         *
         * Original Android code:
        ...
        if (FM_RECORD_STORAGE_PATH == 0) {
            ...
            return Environment.getInternalStoragePath().getPath();
        } else {
            Log.i(TAG, "getDefaultStoragePath :SDCARD");
            String path = "";
            File canonicalFile = null;
            try {
                File externalStorageFile = Environment.getExternalStoragePath();
                if(externalStorageFile != null){
                    canonicalFile = Environment.getExternalStoragePath().getCanonicalFile();
                }
