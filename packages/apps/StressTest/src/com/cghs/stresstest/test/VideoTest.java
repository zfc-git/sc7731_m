...
public class VideoTest extends StressBase implements OnClickListener {
	...
	//private static final String PATH_PREFIX = "/mnt/sdcard/";
	public static final Uri data = Uri.parse("file://" + directory
			+ "/mama.mkv");
	public static final Uri data1 = Uri.parse("file://" + directory
			+ "/nba.mkv");
	
	public String mFilePath = "/storage/sdcard0/test.avi";
	public String mFilePath1 = "/storage/sdcard0/Movies/mama.mkv";
	public String mFilePath2 = "/storage/sdcard0/Movies/nba.mkv";
	...
	//	startService(intent);
	String path=Environment.getExternalStorageDirectory().getPath()+"/Movies/nba.mkv";
	Intent intent = new Intent(this, VideoPlayActivity.class);
			intent.putExtra("path", path);
		
			intent.putExtra("auto",mMaxCount);
			if(mMaxCount!=0){
				intent.putExtra("time",mMaxCount);
			}
			startActivity(intent);
	}
