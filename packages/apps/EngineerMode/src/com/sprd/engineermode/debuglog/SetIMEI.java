...
public class SetIMEI extends Activity implements OnClickListener {
    ...
    private String readIMEI(int i) {
        ...
        if (mATResponse != null && !mATResponse.contains("error")) {
    ...
    private void showRebootDialog() {
        ...
        builder.setTitle(this.getResources().getString(R.string.setimei_title));
