...
public class ActionMenuPresenter extends BaseMenuPresenter
    ...
    private class OverflowPopup extends MenuPopupHelper {
        ...
        public void onDismiss() {
            super.onDismiss();
            /* SPRD: modify 20151125 Spreadtrum of 500871 mMenu may be null in Monkey Test @{ */
            if (mMenu != null) {
                mMenu.close();
            } else if (ActivityManager.isUserAMonkey()) {
                Log.w(TAG, "We didn't init the menu before dismiss. As during monkey testing, skip this exception!");
            } else {
                throw new NullPointerException("We didn't init the menu before dismiss.");
            }
            /* @} */
            mOverflowPopup = null;
        }
    ...
    private class OpenOverflowRunnable implements Runnable {
        ...
        public void run() {
            /* SPRD: modify 20151125 Spreadtrum of 494377 com.android.messaging happens JavaCrash,log:java.lang.NullPointerException @{ */
            if (mMenu != null) {
                mMenu.changeMenuMode();
            } else if (ActivityManager.isUserAMonkey()) {
                Log.w(TAG, "We didn't init the menu before call changeMenuMode. As during monkey testing, skip this exception!");
            } else {
                throw new NullPointerException("We didn't init the menu before call changeMenuMode.");
            }
            /* @} */
