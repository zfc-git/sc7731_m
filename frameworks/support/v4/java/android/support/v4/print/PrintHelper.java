...
public final class PrintHelper {
    ...
    static interface PrintHelperVersionImpl {
        ...
        public void printBitmap(String jobName, Uri imageFile, OnPrintFinishCallback callback, Looper looper)
                throws FileNotFoundException;
    }
    ...
    private static final class PrintHelperKitkatImpl implements PrintHelperVersionImpl {
        ...
        public void printBitmap(String jobName, Uri imageFile,
            ...
            printBitmap(jobName, imageFile, callback, null);
        }

        @Override
        public void printBitmap(String jobName, Uri imageFile,
            final OnPrintFinishCallback callback, Looper looper) throws FileNotFoundException {
            PrintHelperKitkat.OnPrintFinishCallback delegateCallback = null;
            if (callback != null) {
                delegateCallback = new PrintHelperKitkat.OnPrintFinishCallback() {
                    @Override
            ...
            mPrintHelper.printBitmap(jobName, imageFile, delegateCallback, looper);
        }
    }
    ...
    public void printBitmap(String jobName, Uri imageFile, OnPrintFinishCallback callback, Looper looper)
            throws FileNotFoundException {
        mImpl.printBitmap(jobName, imageFile, callback, looper);
    }
}