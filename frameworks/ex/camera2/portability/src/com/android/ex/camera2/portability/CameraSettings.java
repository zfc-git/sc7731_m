...
public abstract class CameraSettings {
    ...
    protected CameraCapabilities.Antibanding mAntibanding;//SPRD:Add for antibanding
    ...
    protected CameraSettings(CameraSettings src) {
        ...
        mAntibanding  = src.mAntibanding;//SPRD:Add for antibanding
    ...
    public Contrast getCurrentContrast() {
    ...
    public Saturation getCurrentSaturation() {
