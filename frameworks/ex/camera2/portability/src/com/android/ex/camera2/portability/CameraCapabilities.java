...
public class CameraCapabilities {
    ...
    protected final EnumSet<BurstNumber> mSupportedBurstNumber= EnumSet.noneOf(BurstNumber.class);//SPRD: fix bug 473462 add burst capture
    ...
    protected final EnumSet<Antibanding> mSupportedAntibanding= EnumSet.noneOf(Antibanding.class);//SPRD:Add for antibanding
    protected final EnumSet<ColorEffect> mSupportedColorEffects = EnumSet.noneOf(ColorEffect.class);//SPRD:Add for color effect Bug 474727
    ...
    public CameraCapabilities(CameraCapabilities src) {
        ...
        mSupportedAntibanding.addAll(src.mSupportedAntibanding);//SPRD:Add for antibanding
        ...
        // SPRD Bug:474721 Feature:Contrast.
        mSupportedContrast.addAll(src.mSupportedContrast);

        // SPRD Bug:474715 Feature:Brightness.
        mSupportedBrightNess.addAll(src.mSupportedBrightNess);
