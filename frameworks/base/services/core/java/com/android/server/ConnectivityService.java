...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    public ConnectivityService(Context context, INetworkManagementService netManager,
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					if (mDrmSocketStream == null) {
						mDrmSocketStream = connectToDrmSocket();
					}
				} catch (Exception e) {}				
			}
		}).start();
	...
	private OutputStream connectToDrmSocket() {
		LocalSocket socket = new LocalSocket();
		try {
		    socket.connect(new LocalSocketAddress("drm_connectivity", LocalSocketAddress.Namespace.RESERVED));
