...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private GlobalActionsDialog createDialog() {
        ...
        for (int i = 0; i < defaultActions.length; i++) {
            ...
            } else if (GLOBAL_ACTION_KEY_REBOOT.equals(actionKey) && ADD_REBOOT_FUNCTION) { // SPRD: add reboot function
				mItems.add(new RebootSinglePressAction(
    ...
    private class RebootSinglePressAction extends SinglePressAction {
        private AlertDialog sConfirmDialog = null;
