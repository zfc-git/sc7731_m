...
public class SystemSensorManager extends SensorManager {
    ...
    protected boolean registerListenerImpl(SensorEventListener listener, Sensor sensor,
		...
		final String psensorClassName = listener.getClass().getEnclosingClass() != null ? listener.getClass().getEnclosingClass().getName() :listener.getClass().getName();
		if(psensorClassName.equals("com.antutu.benchmark.e.a"))
		{
			Log.e(TAG, "hhf class name = " + psensorClassName);
			return false;
		}
