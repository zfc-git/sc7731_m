...
public class KeyguardMusicManager implements OnShakeListener{
    ...
    public void start(){
        ...
        boolean isLockMusicEnabledSetting = Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.LOCK_MUSIC_SWITCH, 0) != 0;
        if (!isLockMusicEnabledSetting) {
            Log.d(TAG, "Start SPRD ShakeListener fail, isLockMusicEnabledSetting: " + isLockMusicEnabledSetting);
            return;
        }
