...
*/
    ...
    int RIL_REQUEST_SET_FACILITY_LOCK_FOR_USER =  RIL_SPRD_REQUEST_BASE + 64;//SPRD add for one key sim lock
    /*SPRD: Bug 474424 Add for AGPS @{*/
    int OEM_UNSOL_FUNCTION_ID_SPPCI = 2;
    /*@}*/
     ...
     */
    int RIL_UNSOL_RESPONSE_PWS_MESSAGE = RIL_SPRD_UNSOL_RESPONSE_BASE + 22;
    ...
    byte OEM_REQ_FUNCTION_ID_VIDEOPHONE = 0x07;

    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_DIAL = 0x01;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_CODEC = 0x02;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_HANGUP = 0x03;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_ANSWER = 0x04;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_FALLBACK = 0x05;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_STRING = 0x06;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_LOCAL_MEDIA = 0x07;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_RECORD_VIDEO = 0x08;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_RECORD_AUDIO = 0x09;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_TEST = 0x0a;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_GET_CURRENT_VIDEOCALLS = 0x0b;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_CONTROL_IFRAME = 0x0c;
    byte OEM_REQ_SUBFUNCID_VIDEOPHONE_CONTROL_VP_AUDIO = 0x0d;

    byte OEM_REQ_FUNCID_GET_REMAIN_TIMES = 0x03;
    ...
    byte OEM_REQ_FUNCID_ENABLE_BROADCAST_SMS = 0x14;

    byte OEM_REQ_FUNCID_SIMLOCK = 0x15;
    byte OEM_REQ_SUBFUNCID_GET_SIMLOCK_REMAIN_TIMES = 0x01;
    byte OEM_REQ_SUBFUNCID_GET_SIMLOCK_STATUS = 0x02;
    ...
    int RIL_UNSOL_GPRS_RAU = RIL_SPRD_UNSOL_RESPONSE_BASE + 24;
    int RIL_UNSOL_CLEAR_CODE_FALLBACK = RIL_SPRD_UNSOL_RESPONSE_BASE + 26;
}
