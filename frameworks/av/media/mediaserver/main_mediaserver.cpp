...
int main(int argc __unused, char** argv)
{
	...
	property_get("ro.config.low_ram", property_value, "false");   //add for video recored crash low ram 20161110
	//ALOGI("ro.config.low_ram property_value: %s", property_value);
    if (strcmp(property_value, "false") == 0) {
	limitProcessMemory(
