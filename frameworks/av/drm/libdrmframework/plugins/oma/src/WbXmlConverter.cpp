...
String8 WbXmlConverter::readString()
{
    ...
    switch (byte) {
		...
		ret.appendFormat("%c", byte);
			...
			SUNWAY_NOISY(ALOGE("WbXmlConverter:: readString TOKEN_STR_I: %s", ret.string()));
            break;
		...
		SUNWAY_NOISY(ALOGE("WbXmlConverter:: readString TOKEN_ENTITY: %s", ret.string()));
            break;
        }
		...
		SUNWAY_NOISY(ALOGE("WbXmlConverter:: readString TOKEN_STR_T: %s", ret.string()));
	    break;
        }
