...
public class ApnSetting {
    ...
    public ApnSetting(int id, String numeric, String carrier, String apn,
            ...
            String protocol, String roamingProtocol, boolean carrierEnabled, int bearer,
            int bearerBitmask, int profileId, boolean modemCognitive, int maxConns, int waitTime,
            int maxConnsTime, int mtu, String mvnoType, String mvnoMatchData, String trafficClass) {
        this.id = id;
        this.numeric = numeric;
        this.carrier = carrier;
        this.apn = apn;
    ...
    public static ApnSetting fromString(String data) {
        ...
        if (version == 1) {
            ...
            carrierEnabled = true;
            // SPRD: Set the default value.
            trafficClass = "2";
        } else {
            // SPRD:Add the trafficClass,so length is 19.
            if (a.length <= 18) {
                return null;
            }
            ...
            // SPRD: Get the value of trafficClass.
            trafficClass = a[18];
            if (a.length > 22) {
        ...
        /* SPRD: Return a new ApnSetting when add trafficClass. @{ */
        if (SupportTrafficClassUtils.getInstance().isSupportTracfficClass()) {
            return new ApnSetting(-1,a[10]+a[11],a[0],a[1],a[2],a[3],a[7],a[8],
                    ...
                    mvnoType, mvnoMatchData, trafficClass);
        } else {
            return new ApnSetting(-1,a[10]+a[11],a[0],a[1],a[2],a[3],a[7],a[8],
                    a[9],a[4],a[5],authType,typeArray,protocol,roamingProtocol,carrierEnabled,0,
                    bearerBitmask, profileId, modemCognitive, maxConns, waitTime, maxConnsTime, mtu,
    ...
    public static boolean mvnoMatches(IccRecords r, String mvnoType, String mvnoMatchData) {
        if (mvnoType.equalsIgnoreCase("spn")) {
            /* SPRD: [bug507443] Make sure spn value is loaded from sim and haven't been covered. @{ */
...
//            }
        ...
        /* SPRD: [bug507443] Add for mvno match type PNN. @{ */
