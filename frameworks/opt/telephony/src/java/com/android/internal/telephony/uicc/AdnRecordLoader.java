...
public class AdnRecordLoader extends Handler {
        ...
        try {
            switch (msg.what) {
                case EVENT_EF_LINEAR_RECORD_SIZE_DONE:
                    /* SPRD: add SIMPhoneBook for bug 474587 @{ */
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_EF_LINEAR_RECORD_SIZE_DONE, ef:" + Integer.toHexString(mEf));
                   /* @} */
                   ...
                   Rlog.i("AdnRecordLoader", "recordNumber " + mRecordNumber + "adn.ext"
                           + adn.mExtRecord);
                   /* @} */
                   if(data == null) {
                ...
                case EVENT_ADN_LOAD_DONE:
                    /* SPRD: add SIMPhoneBook for bug 474587 @{ */
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_ADN_LOAD_DONE");
                    /* @} */
                    ar = (AsyncResult)(msg.obj);
                    data = (byte[])(ar.result);
                ...
                case EVENT_EXT_RECORD_LOAD_DONE:
                    /* SPRD: add SIMPhoneBook for bug 474587 @{ */
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_EXT_RECORD_LOAD_DONE");
                    /* @} */
                    ar = (AsyncResult)(msg.obj);
                    data = (byte[])(ar.result);
                    adn = (AdnRecord)(ar.userObj);
                ...
                case EVENT_ADN_LOAD_ALL_DONE:
                    /* SPRD: add SIMPhoneBook for bug 474587 @{ */
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_ADN_LOAD_ALL_DONE");
                    /* @} */
                    ar = (AsyncResult)(msg.obj);
                ...
                case EVENT_EXT_LOAD_ALL_DONE:
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_EXT_LOAD_ALL_DONE");
                    ar = (AsyncResult) (msg.obj);
                ...
                case EVENT_EF_CYCLIC_LINEAR_RECORD_SIZE_DONE:
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_EF_CYCLIC_LINEAR_RECORD_SIZE_DONE, ef:" + Integer.toHexString(mEf));
                    ar = (AsyncResult)(msg.obj);
                    adn = (AdnRecord)(ar.userObj);
                    if (ar.exception != null) {
                        throw new IccPhoneBookOperationException(
                   ...
                   if (CyclicrecordSize.length != 3 || mRecordNumber > CyclicrecordSize[2]) {
                    ...
                    Rlog.i("AdnRecordLoader", "recordNumber " + mRecordNumber);
                ...
                case EVENT_UPDATE_ANR_RECORD_DONE:
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_UPDATE_ANR_RECORD_DONE");
                    ar = (AsyncResult) (msg.obj);
                    if (ar.exception != null) {
                        throw new IccPhoneBookOperationException(
                                IccPhoneBookOperationException.WRITE_OPREATION_FAILED,
                ...
                case EVENT_UPDATE_EXT_RECORD_DONE:
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_UPDATE_EXT_RECORD_DONE");
                    ar = (AsyncResult) (msg.obj);
                ...
                case EVENT_GET_SIZE_DONE:
                    Rlog.d(LOG_TAG,"AdnRecordLoader handle EVENT_GET_SIZE_DONE");
                    ar = (AsyncResult) msg.obj;
                    synchronized (mLock) {
                        if (ar.exception == null) {
                ...
                case EVENT_EF_PBR_SNE_LINEAR_RECORD_SIZE_DONE:
                    ...
                    if (recordSize.length != 3) {
                        throw new IccPhoneBookOperationException(IccPhoneBookOperationException
                                  .WRITE_OPREATION_FAILED, "get wrong EF record size format", ar.exception);
                    }
                    ...
                    for (int i = 0, size = sneEfids.size(); i < size; i++) {
                         ...
                         if (sneEfids.get(i) != 0 &&sneNums.get(i)!=0 ) {
                             ...
                             if (data == null) {
                                 throw new IccPhoneBookOperationException(IccPhoneBookOperationException
                                          .WRITE_OPREATION_FAILED,"wrong ADN format", ar.exception);
                              }
                              mFh.updateEFLinearFixed(sneEfids.get(i), sneNums.get(i), data,mPin2,obtainMessage(EVENT_UPDATE_SNE_RECORD_DONE));
                         }
                     }
                    mPendingExtLoads = 1;
                    break;
    ...
    public void updateEFEmailToUsim(AdnRecord adn, ArrayList<Integer> emailEfids,
            ...
            Rlog.i("AdnRecordLoader ","updateEFEmailToUsim  emailEfids " +emailEfids
    ...
    public void updateEFAdnToUsim(AdnRecord adn, int ef, int extensionEF,
        ...
        Rlog.i("AdnRecordLoader", "recordNumber " + recordNumber + "adn.ext"
                + adn.mExtRecord);
    ...
    /*@}*/
    /* SPRD: PhoneBook for SNE {@ */
    public void updateEFSneToUsim(AdnRecord adn, ArrayList<Integer> sneEfids,
