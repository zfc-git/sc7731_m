...
import static com.android.internal.telephony.cat.CatCmdMessage.SetupEventListConstants.MT_CALL_EVENT;
import static com.android.internal.telephony.cat.CatCmdMessage.SetupEventListConstants.CALL_CONNECTED_EVENT;
import static com.android.internal.telephony.cat.CatCmdMessage.SetupEventListConstants.CALL_DISCONNECTED_EVENT;
import static com.android.internal.telephony.cat.CatCmdMessage.SetupEventListConstants.LOCATION_STATUS_EVENT;
/* @} */
...
public class CatService extends Handler implements AppInterface {
        ...
        switch (cmdParams.getCommandType()) {
            ...
            case REFRESH:
                ...
                if (mRefreshHandled == false) {
                    if (mCurrntCmd.mCmdDet.commandQualifier == CommandParamsFactory.REFRESH_NAA_APP_RESET) {
                        CatLog.d(this, "<" + mSlotId + ">"
            ...
            case CLOSE_CHANNEL:
                ...
                if (deviceIdentities != null) {
                    ...
                    if (channelId != AppInterface.DEFAULT_CHANNELID) {
                        ...
                        sendTerminalResponse(cmdParams.mCmdDet, ResultCode.BIP_ERROR, true,
        ...
        case MSG_ID_ALPHA_NOTIFY:
            ...
            if (msg.obj != null) {
                ...
                if (ar != null && ar.result != null) {
                    ...
                    broadcastAlphaMessage((CallControlResult)ar.result);
                    /* @} */
                } else {
    ...
    /*SPRD: modify for alpha identifier display in stk @{ */
    private void broadcastAlphaMessage(CallControlResult result) {
        if (result.alpha_len !=0 && result.alpha_data != null) {
            byte[] rawValue = IccUtils.hexStringToBytes(result.alpha_data);
            String alphaString = IccUtils.adnStringFieldToString(rawValue, 0, result.alpha_len);
    ...
    private void handleCmdResponse(CatResponseMessage resMsg) {
        ...
        case TERMINAL_CRNTLY_UNABLE_TO_PROCESS:
            ...
            case RECEIVE_DATA:
                ...
                resp = new ReceiveDataResponseData(resMsg.channelDataLen,
                        resMsg.channelData);
                break;
            case GET_CHANNEL_STATUS:
