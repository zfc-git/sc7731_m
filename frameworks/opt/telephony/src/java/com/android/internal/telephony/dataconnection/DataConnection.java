...
public final class DataConnection extends StateMachine {
    ...
    private void onConnect(ConnectionParams cp) {
        ...
        if (SupportTrafficClassUtils.getInstance().isSupportTracfficClass()) {
            TelephonyManager tm = TelephonyManager.getDefault();
            String trafficClass = mApnSetting.trafficClass;
            int respCode = tm.invokeOemRilRequestStrings(mPhone.getPhoneId(),
                    new String[] { "1," + trafficClass }, new String[1]);
            log("Support trafficClass: " + trafficClass + " and respCode = " + respCode);
        }
        /* @} */
    ...
    private NetworkCapabilities makeNetworkCapabilities() {
        ...
        /* SPRD: Bug 496815 Adjust network capability when mobile data is disabled @{ */
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case DcAsyncChannel.REQ_SET_LINK_PROPERTIES_HTTP_PROXY: {
                    ...
                    /*SPRD: bug 517557 set mLinkProperties to networkAgent @{*/
    ...
    private boolean updateNetworkInfoSuspendState() {
        ...
        if (sst.getCurrentDataConnectionState() != ServiceState.STATE_IN_SERVICE) {
            /* SPRD: Bug 494060 DC should not change network info @{ */
            ...
            if (sst.isConcurrentVoiceAndDataAllowed() == false) {
                ...
                if (ct.getState() != PhoneConstants.State.IDLE ||
                        ...
                        ((ImsPhone)mPhone.getImsPhone()).getCallTracker().getState() != PhoneConstants.State.IDLE)) {
                    /* SPRD: Bug 494060 DC should not change network info @{ */
                    mNetworkInfo.setDetailedState(NetworkInfo.DetailedState.SUSPENDED,
                            mNetworkInfo.getReason(), mNetworkInfo.getExtraInfo());
                    /* @} */
