...
public class SmsMessage extends SmsMessageBase {
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
        ...
        Rlog.i(LOG_TAG+" - encodeTypeLog", " - SmsMessage - getSubmitPdu encoding:"+encoding);
        ...
        if (validity != 0) {
            bo.write(validity);
            Rlog.i(LOG_TAG, "SmsMessage --> write into TP-VP:" + validity);
        }
    ...
    private static ByteArrayOutputStream getSubmitPduHead(
        ...
        if (validity != 0) {
            mtiByte |= 0x10;
            Rlog.i(LOG_TAG, "SmsMessage --> TP-VPF = 0x" + mtiByte);
        }
        /* SPRD add for Bug 489211 end */
    ...
    public static void getSmsValidity(Context context, int subId) {
        ...
        if (null != context) {
            validityStr = SystemProperties.get("persist.radio.smstime" + subId);
        }
