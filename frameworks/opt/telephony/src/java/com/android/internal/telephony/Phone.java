...
public interface Phone {
    ...
    static final String REASON_ROUTING_AREA_UPDATE = "RoutingAreaUpdate";
   ...
   /**
     ...
     *
     * @param videoState The video state in which to answer the call.
     * @param mpcMode The mode of answer the call.
     * @exception CallStateException when no call is ringing or waiting
     */
    void acceptCall(int videoState, int mpcMode) throws CallStateException;
