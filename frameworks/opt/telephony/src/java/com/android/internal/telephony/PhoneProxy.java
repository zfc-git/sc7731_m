...
public class PhoneProxy extends Handler implements Phone {
    ...
    public void registerForSwitchDataCardComplete(Handler h, int what, Object obj) {
        DctController.getInstance().registerForSwitchDataCardComplete(h, what, obj);
    }

    public void unRegisterForSwitchDataCardComplete(Handler h) {
        DctController.getInstance().unRegisterForSwitchDataCardComplete(h);
    }
    /* @} */
    ...
    acceptCall(int videoState, int mpcMode) throws CallStateException {
        mActivePhone.acceptCall(videoState, mpcMode);
    }

    /**
     * SPRD: Add interfaces for FDN. @{
     */
    @Override
    ...
    public void setCallForwardingOption(int commandInterfaceCFAction,
        ...
        mActivePhone.setCallForwardingOption(commandInterfaceCFAction, commandInterfaceCFReason,
