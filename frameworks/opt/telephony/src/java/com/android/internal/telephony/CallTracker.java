...
public abstract class CallTracker extends Handler {
    ...
    // SPRD: Fix to handle ConcurrentModificationException.
//    protected ArrayList<Connection> mHandoverConnections = new ArrayList<Connection>();
    protected CopyOnWriteArrayList<Connection> mHandoverConnections = new CopyOnWriteArrayList<Connection>();
    ...
    protected static final int EVENT_CALL_ACCEPT                   = 21;   //SPRD:CALL ACCEPT
    ...
    protected Connection getHoConnection(DriverCall dc) {
        for (Connection hoConn : mHandoverConnections) {
            ...
            if (hoConn.getAddress() != null
                    && dc != null && dc.number != null//SPRD: Add for VoLTE
