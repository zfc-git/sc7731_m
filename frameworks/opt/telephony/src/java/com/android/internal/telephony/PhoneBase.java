...
public abstract class PhoneBase extends Handler implements Phone {
    ...
    protected static final int EVENT_GET_REMIAN_TIMES_DONE          = 39;
    ...
    protected static final int EVENT_DEFAULT_PHONE_DATA_STATE_CHANGED  = 45;
    /* }@ */
    protected static final int EVENT_GET_SIMLOCK_REMIAN_TIMES_DONE  = 46;//for sim lock
    protected static final int EVENT_GET_SIMLOCK_STATUS_DONE        = 47;
    /* SPRD: add for VoLTE. @{ */
    protected static final int EVENT_GET_IMS_CALL_FORWARD_DONE      = 48;
    /* }@ */
    protected static final int EVENT_LAST                           = EVENT_GET_IMS_CALL_FORWARD_DONE;
     ...
     */
    // SPRD: modify for gsmphone bug479433
    ...
    */
    ...
    public boolean isVideoEnabled() {
        ...
        if ((imsPhone != null)
            ...
            /* SPRD:bug491169 @{ */
            boolean is4G = false;
            is4G = TelephonyManager.getRadioCapbility() != TelephonyManager.RadioCapbility.NONE;
            mIsVideoCapable = SystemProperties.getBoolean("persist.sys.support.vt", false) && !is4G;
    ...
    public void setCallForwardingOption(int commandInterfaceCFAction,
        ...
        Rlog.w(LOG_TAG, "Empty implement of setCallForwardingOption.");
    }

    @Override
    public void getCallForwardingOption(int commandInterfaceCFReason, int serviceClass,
            String ruleSet, Message onComplete){
        Rlog.w(LOG_TAG, "Empty implement of getCallForwardingOption.");
    }
    /* @} */
}
