...
import com.android.internal.telephony.ImsRILConstants;
import com.android.ims.ImsCallForwardInfo;
import com.android.internal.telephony.cat.CallControlResult;
...
public final class RIL extends BaseCommands implements CommandsInterface {
    ...
    public void setFacilityLockByUser(String facility, boolean lockState, Message response) {
        String lockString;
        RILRequest rr
                = RILRequest.obtain(RIL_REQUEST_SET_FACILITY_LOCK_FOR_USER, response);
 ...
 | sed -re 's/\{([^,]+),[^,]+,([^}]+).+/case \1: ret = \2(p); break;/'
            ...
            case RIL_REQUEST_SET_FACILITY_LOCK_FOR_USER: ret =  responseVoid(p); break;//SPRD add for sim lock
            ...
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMPU: ret = responseVoid(p); break;
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMPI: ret = responseVoid(p); break;
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_DOMAIN: ret = responseVoid(p); break;
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMEI: ret = responseVoid(p); break;
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_BSF: ret = responseVoid(p); break;
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_XCAP: ret = responseVoid(p); break;
            ...
            case ImsRILConstants.RIL_REQUEST_IMS_SET_CONFERENCE_URI: ret =  responseInts(p);break;
        ...
        if (error != 0) {
            switch (rr.mRequest) {
                ...
                case RIL_REQUEST_SET_FACILITY_LOCK_FOR_USER://SPRD add for sim lock
                    if (mIccStatusChangedRegistrants != null) {
                        if (RILJ_LOGD) {
...
*/
            ...
            case RIL_UNSOL_ON_USSD: ret =  /** SPRD: Porting USSD. @origresponseStrings(p)*/ responseUnsolUssdStrings(p); break;
            ...
            case RIL_UNSOL_STK_CC_ALPHA_NOTIFY: ret =  responseCallControlResult(p); break;
            /* @} */
            case RIL_UNSOL_LCEDATA_RECV: ret = responseLceData(p); break;
            /*SPRD: Bug 474689 Add for SPWRN feature @{*/
            case RIL_UNSOL_RESPONSE_PWS_MESSAGE: ret = responsePWSMessage(p); break;
            /*@}*/
            /* SPRD: add for bug479433 @{ */
            ...
            /* @} */
            case ImsRILConstants.RIL_UNSOL_RESPONSE_IMS_CALL_STATE_CHANGED: ret = responseVoid(p); break;//SPRD:add for VoLTE
            /* SPRD: add for DATA CLEAR CODE @{ */
            case RIL_UNSOL_GPRS_RAU: ret = responseVoid(p); break;
            /* @} */
            case ImsRILConstants.RIL_UNSOL_RESPONS_IMS_CONN_ENABLE: ret = responseInts(p); break;
            case RIL_UNSOL_CLEAR_CODE_FALLBACK: ret = responseVoid(p); break;
            default:
        ...
        switch(response) {
            ...
            case RIL_UNSOL_OEM_HOOK_RAW:
                ...
                if (mOemHookRawRegistrants != null) {
                    mOemHookRawRegistrants.notifyRegistrants(new AsyncResult(null, ret, null));
                }
                /* @} */
                break;
            ...
            case RIL_UNSOL_RIL_CONNECTED: {
                ...
                /* SPRD: fix bug 501191 @{ */
                riljLog("mDefaultDisplay.getState()" + mDefaultDisplay.getState());
            ...
            case RIL_UNSOL_LCEDATA_RECV:
                ...
                /*SPRD: Bug 474689 Add for SPWRN feature @{*/
            case RIL_UNSOL_RESPONSE_PWS_MESSAGE:
                if (RILJ_LOGD)
                    unsljLog(response);
                if (mPWSMessageRegistrant != null) {
                    mPWSMessageRegistrant.notifyRegistrant(new AsyncResult(null, ret, null));
                }
                break;
                /*@}*/
            /* SPRD: add for bug479433 @{ */
            case RIL_UNSOL_RESPONSE_VIDEOCALL_STATE_CHANGED:
                if (RILJ_LOGD)
                    unsljLog(response);
                Rlog.i(RILJ_LOG_TAG, "ril--RIL_UNSOL_RESPONSE_VIDEOCALL_STATE_CHANGED");
                mVideoCallStateRegistrants.notifyRegistrants(new AsyncResult(null, null, null));
                break;
            ...
            case RIL_UNSOL_VIDEOPHONE_CODEC: {
                ...
                int[] params = (int[]) ret;
                mVPCodecRegistrants.notifyRegistrants(new AsyncResult(null, params, null));
                break;
            }
            case RIL_UNSOL_VIDEOPHONE_STRING:
                ...
                if (mVPStrsRegistrant != null) {
                    mVPStrsRegistrant.notifyRegistrants(new AsyncResult(null, ret, null));
                }
                break;
            ...
            case RIL_UNSOL_VIDEOPHONE_REMOTE_MEDIA: {
                ...
                if (params.length >= 2) {
                    if (mVPRemoteMediaRegistrant != null) {
                        mVPRemoteMediaRegistrant.notifyRegistrants(new AsyncResult(null, params,
                                null));
                    }
                } else {
                    if (RILJ_LOGD)
            ...
            case RIL_UNSOL_VIDEOPHONE_MM_RING: {
                ...
                if (params.length == 1) {
                    if (mVPMMRingRegistrant != null) {
                        mVPMMRingRegistrant.notifyRegistrants(new AsyncResult(null, params, null));
                    }
                } else {
                    if (RILJ_LOGD)
                ...
                if (params.length == 1) {
                    if (mVPRecordVideoRegistrant != null) {
                        mVPRecordVideoRegistrant
                                .notifyRegistrants(new AsyncResult(null, params,
                                        null));
                    }
                } else {
                    if (RILJ_LOGD)
            ...
            case RIL_UNSOL_VIDEOPHONE_MEDIA_START: {
                ...
                if (mVPMediaStartRegistrant != null) {
                    int[] params = (int[]) ret;
                    if (params[0] == 1) {
                        mVPMediaStartRegistrant.notifyRegistrants(new AsyncResult(null, params,
                                null
                                ));
                    }
                }
            ...
            case RIL_UNSOL_VIDEOPHONE_DSCI: {
                ...
                if (info.cause > 0) {
                    ...
                    if ((info.cause == 47) || (info.cause == 57) || (info.cause == 50)
                            || (info.cause == 58)
                            || (info.cause == 88) || (info.cause == 69)) {
                        if (mVPFallBackRegistrant != null) {
                            if ((info.cause == 57 || info.cause == 50) && (info.location <= 2)) {
                                // if cause = 57 and location <= 2, it mean current sim hasn't start vt service
                                mVPFallBackRegistrant
                                        .notifyRegistrants(new AsyncResult(
                                                ...
                                                new AsyncResult(
                                                        ...
                                                        new AsyncResult(
                                                                info.number,
                                                                (info.location == 2 ? (info.cause + 200)
                                                                        : (info.cause + 100)), null),
                                                        null), null));// SPRD modify for 303916
                            } else {
                                mVPFallBackRegistrant.notifyRegistrants(new AsyncResult(null,
                                        new AsyncResult(info.idr,
                                                new AsyncResult(info.number, info.cause, null),
                                                null), null));
                            }
                        }
                    } else {
                        if (mVPFailRegistrant != null) {
                            mVPFailRegistrant.notifyRegistrants(new AsyncResult(null,
                                    new AsyncResult
                                    (info.idr,
            ...
            case RIL_UNSOL_VIDEOPHONE_RELEASING: {
                ...
                if (mVPFailRegistrant != null) {
                    mVPFailRegistrant.notifyRegistrants(new AsyncResult(null, new AsyncResult(null,
                            new AsyncResult(str, 1000, null), null), null));
                }
                break;
            }
            /* @} */
            ...
            case ImsRILConstants.RIL_UNSOL_RESPONSE_IMS_CALL_STATE_CHANGED:
                ...
                break;
            /* @} */
            /* SPRD: add add for DATA CLEAR CODE @{ */
            case RIL_UNSOL_GPRS_RAU:
                if (RILJ_LOGD) unsljLog(response);
                if (mRauSucessRegistrant != null) {
                    mRauSucessRegistrant.notifyRegistrant(
                        new AsyncResult(null, ret, null));
                }
                break;
            case RIL_UNSOL_CLEAR_CODE_FALLBACK:
                if (RILJ_LOGD) unsljLog(response);
                if (mClearCodeFallBackRegistrant != null) {
                    mClearCodeFallBackRegistrant.notifyRegistrant(
                            new AsyncResult(null, ret, null));
                }
            break;
            /* @} */
            case ImsRILConstants.RIL_UNSOL_RESPONS_IMS_CONN_ENABLE:
                if (mConnImsenRegistrant != null) {
                    mConnImsenRegistrant.notifyRegistrant(new AsyncResult(null, ret, null));
                }
        }
    }
...
*/
        switch(request) {
            ...
            case RIL_REQUEST_SET_FACILITY_LOCK_FOR_USER: return "SET_FACILITY_LOCK_BY_USER";//SPRD add for sim lock
...
*/
        switch(request) {
            ...
            case RIL_UNSOL_RESPONSE_PWS_MESSAGE: return "UNSOL_RESPONSE_PWS_MESSAGE";
            /* SPRD: add for bug479433 @{ */
            ...
            case ImsRILConstants.RIL_UNSOL_RESPONSE_IMS_CALL_STATE_CHANGED: return " RIL_UNSOL_RESPONSE_IMS_CALL_STATE_CHANGED";//SPRD:add for VoLTE
            /* @} */
            /* SPRD: add for DATA CLEAR CODE */
            case RIL_UNSOL_GPRS_RAU: return "UNSOL_GPRS_RAU";
            case ImsRILConstants.RIL_UNSOL_RESPONS_IMS_CONN_ENABLE: return "RIL_UNSOL_RESPONS_IMS_CONN_ENABLE";
            case RIL_UNSOL_CLEAR_CODE_FALLBACK: return "UNSOL_CLEAR_CODE_FALLBACK";
    ...
    */
    ...
    public void dialVP(String address, String sub_address, int clirMode, Message result) {
        ...
        RILRequest rr = RILRequest.obtain(RIL_REQUEST_VIDEOPHONE_DIAL/* RIL_REQUEST_DIALVIDEO */,
                result);
        ...
        if (RILJ_LOGD)
            riljLog(rr.serialString() + "> " + RIL.requestToString(rr.mRequest));

        send(rr);
    }

    public void codecVP(int type, Bundle param, Message result) {
        RILRequest rr = RILRequest.obtain(RIL_REQUEST_VIDEOPHONE_CODEC, result);
    ...
    private final class DSCIInfo {
        ...
        int bs_type;
        int cause;
        int location; // if cause = 57 and location <= 2, it mean current sim hasn't start vt
                      // service
    }
    ...
    protected Object
        ...
        riljLog("responseDSCI(), number: " + info.number + ", status: " + info.stat + ", type: "
                + info.type + ", cause: " + info.cause + ", location: " + info.location);
    ...
    protected RegistrantList mVPStrsRegistrant = new RegistrantList();
    protected RegistrantList mVPRemoteMediaRegistrant = new RegistrantList();
    protected RegistrantList mVPMMRingRegistrant = new RegistrantList();
    protected RegistrantList mVPRecordVideoRegistrant = new RegistrantList();
    protected RegistrantList mVPMediaStartRegistrant = new RegistrantList();
    protected RegistrantList mVPFallBackRegistrant = new RegistrantList();
    protected RegistrantList mVPFailRegistrant = new RegistrantList();
    ...
    public void registerForOemHookRaw(Handler h, int what, Object obj) {
        ...
        switch (what) {
            ...
            case RIL_UNSOL_VIDEOPHONE_STRING:
                mVPStrsRegistrant.add(r);
                break;

            case RIL_UNSOL_VIDEOPHONE_REMOTE_MEDIA:
                mVPRemoteMediaRegistrant.add(r);
                break;

            case RIL_UNSOL_VIDEOPHONE_MM_RING:
                mVPMMRingRegistrant.add(r);
                break;

            case RIL_UNSOL_VIDEOPHONE_RECORD_VIDEO:
                mVPRecordVideoRegistrant.add(r);
                break;

            case RIL_UNSOL_VIDEOPHONE_MEDIA_START:
                mVPMediaStartRegistrant.add(r);
                break;

            case RIL_UNSOL_VIDEOPHONE_DSCI:
                mVPFallBackRegistrant.add(r);
                break;

            case RIL_UNSOL_VIDEOPHONE_RELEASING:
                mVPFailRegistrant.add(r);
                break;

            default:
                mOemHookRawRegistrants.add(r);
                break;
        }
    }
    ...
    public void unregisterForOemHookRaw(Handler h) {
        super.unregisterForOemHookRaw(h);
        mOemHookRawRegistrants.remove(h);
        mVideoCallStateRegistrants.remove(h);
        mVPCodecRegistrants.remove(h);
        mVPStrsRegistrant.remove(h);
        mVPRemoteMediaRegistrant.remove(h);
        mVPMMRingRegistrant.remove(h);
        mVPRecordVideoRegistrant.remove(h);
        mVPMediaStartRegistrant.remove(h);
        mVPFallBackRegistrant.remove(h);
        mVPFailRegistrant.remove(h);
    }
    /* @} */

    /** SPRD: Porting USSD. @{*/
    protected Object responseUnsolUssdStrings(Parcel p) {
        ...
        if (response.length > 2) {
            ...
            if (num == GSM_TYPE) {
                ...
                response[1] = GsmAlphabet.gsm8BitUnpackedToString(dataUssd, 0,
                        dataUssd.length);
    ...
    public void registerForImpu(Message response, String impu) {
        RILRequest rr = RILRequest.obtain(
                ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMPU, response);
        rr.mParcel.writeString(impu);
        if (RILJ_LOGD)
            riljLog(rr.serialString() + "> " + imsRequestToString(rr.mRequest));
        send(rr);
    ...
    public void registerForImpi(Message response, String impi) {
        RILRequest rr = RILRequest.obtain(
                ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMPI, response);
        rr.mParcel.writeString(impi);
        if (RILJ_LOGD)
            riljLog(rr.serialString() + "> " + imsRequestToString(rr.mRequest));
        send(rr);
    ...
    public void registerForDomain(Message response, String domain) {
        RILRequest rr = RILRequest.obtain(
                ImsRILConstants.RIL_REQUEST_REGISTER_IMS_DOMAIN, response);
        rr.mParcel.writeString(domain);
        if (RILJ_LOGD)
            riljLog(rr.serialString() + "> " + imsRequestToString(rr.mRequest));
        send(rr);
    ...
    public void registerForImei(Message response, String imei) {
        RILRequest rr = RILRequest.obtain(
                ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMEI, response);
        rr.mParcel.writeString(imei);
        if (RILJ_LOGD)
            riljLog(rr.serialString() + "> " + imsRequestToString(rr.mRequest));
        send(rr);
    }
    ...
    public void registerForXcap(Message response, String xcap) {
        RILRequest rr = RILRequest.obtain(
                ImsRILConstants.RIL_REQUEST_REGISTER_IMS_XCAP, response);
        rr.mParcel.writeString(xcap);
        if (RILJ_LOGD)
            riljLog(rr.serialString() + "> " + imsRequestToString(rr.mRequest));
        send(rr);
    ...
    public void registerForBsf(Message response, String bsf) {
        RILRequest rr = RILRequest.obtain(
                ImsRILConstants.RIL_REQUEST_REGISTER_IMS_BSF, response);
        rr.mParcel.writeString(bsf);
        if (RILJ_LOGD)
            riljLog(rr.serialString() + "> " + imsRequestToString(rr.mRequest));
        send(rr);
    }
    ...
    public void setConferenceUri(Message response, String uri) {
        RILRequest rr = RILRequest.obtain(
                ImsRILConstants.RIL_REQUEST_IMS_SET_CONFERENCE_URI, response);
        rr.mParcel.writeString(uri);
        if (RILJ_LOGD)
            riljLog(rr.serialString() + "> " + imsRequestToString(rr.mRequest));
        send(rr);
    }
    ...
    responseCallForwardUri(Parcel p) {
        ...
        infos = new ImsCallForwardInfo[numInfos];

        for (int i = 0 ; i < numInfos ; i++) {
            infos[i] = new ImsCallForwardInfo();
            ...
            riljLog("responseCallForwardUri> "
                    ...
                    + " infos[i].ruleset" + infos[i].mRuleset);
        }
    ...
    imsRequestToString(int request) {
        switch(request) {
            ...
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMPU: return "RIL_REQUEST_REGISTER_IMS_IMPU";
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMPI: return "RIL_REQUEST_REGISTER_IMS_IMPI";
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_DOMAIN: return "RIL_REQUEST_REGISTER_IMS_DOMAIN";
            case ImsRILConstants.RIL_REQUEST_DISABLE_IMS: return "RIL_REQUEST_DISABLE_IMS";
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_IMEI: return "RIL_REQUEST_REGISTER_IMS_IMEI";
            ...
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_XCAP: return "RIL_REQUEST_REGISTER_IMS_XCAP";
            case ImsRILConstants.RIL_REQUEST_REGISTER_IMS_BSF: return "RIL_REQUEST_REGISTER_IMS_BSF";
            ...
            case ImsRILConstants.RIL_REQUEST_IMS_SET_CONFERENCE_URI: return "RIL_REQUEST_IMS_SET_CONFERENCE_URI";
    ...
    /* @} */
    /*SPRD: add for alpha identifier display in stk @{ */
    private Object responseCallControlResult(Parcel p) {
        CallControlResult result = new CallControlResult();
        result.call_type =p.readInt();
        result.result=p.readInt();
        result.is_alpha = p.readInt();
        result.alpha_len=p.readInt();
        result.alpha_data=p.readString();
        result.pre_type=p.readInt();
        result.ton=p.readInt();
        result.npi=p.readInt();
        result.num_len=p.readInt();
        result.number=p.readString();
        return result;
    }
    /* @} */

    /** SPRD: Kill-stop mechanism */
    private void sendKillStopToAms() {
