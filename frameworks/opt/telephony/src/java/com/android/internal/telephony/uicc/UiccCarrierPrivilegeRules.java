...
public class UiccCarrierPrivilegeRules extends Handler {
    ...
    // SPRD: Add AID_READY
    private static final int EVENT_AID_READY = 10;
    ...
    public UiccCarrierPrivilegeRules(UiccCard uiccCard, Message loadedCallback) {
        ...
        mRules = "";
        /* SPRD: modify the Bug494943 @{ */
        mHandler = mLoadedCallback.getTarget();
        mWhat = mLoadedCallback.what;
        /* @} */

        /* SPRD: [bug452051] Open logical channel after aid loaded @{ */
        UiccCardApplication app = uiccCard.getApplication(UiccController.APP_FAM_3GPP);
        IccRecords iccRecords = app.getIccRecords();
        if (iccRecords != null) {
            iccRecords.registerForAidReady(this, EVENT_AID_READY, null);
        }
        /* @} */
    }
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
          ...
          case EVENT_CLOSE_LOGICAL_CHANNEL_DONE:
              ...
              /* SPRD: [bug452051] Open logical channel after aid loaded @{ */
          case EVENT_AID_READY:
              Rlog.d(LOG_TAG, "EVENT_AID_READY");
              ar = (AsyncResult) msg.obj;
              if (ar.exception == null && ar.result != null) {
                  String aid = (String)ar.result;
                  // Start loading the rules.
                  mUiccCard.iccOpenLogicalChannel(aid,
                      obtainMessage(EVENT_OPEN_LOGICAL_CHANNEL_DONE, null));
              } else {
                  updateState(STATE_ERROR, "Error occurred while getting AID.");
              }
              break;
              /* @} */
    ...
    private void updateState(int newState, String statusMessage) {
        mState.set(newState);
        /* SPRD: modify the Bug 507969  @{ */
//        if (mLoadedCallback != null) {
//            if (mLoadedCallback.getTarget()!= null) {
//                mLoadedCallback.sendToTarget();
//            } else {
        Rlog.e(LOG_TAG, "mHandler = "+ mHandler.hashCode());
