...
public final class CallManager {
    ...
    */
    ...
    private void registerForPhoneStates(Phone phone) {
        ...
        /* SPRD: add for bug479433 @{ */
        phone.registerForNewRingingVideoCall(handler, EVENT_NEW_RINGING_VIDEO_CALL, null);
        phone.registerForPreciseVideoCallStateChanged(handler,
                EVENT_PRECISE_VIDEO_CALL_STATE_CHANGED, null);
        phone.registerForVideoCallDisconnect(handler, EVENT_VIDEO_CALL_DISCONNECT, null);
        phone.registerForVideoCallFallBack(handler, EVENT_VIDEO_CALL_FALL_BACK, null);
        phone.registerForVideoCallFail(handler, EVENT_VIDEO_CALL_FAIL, null);
        phone.registerForVideoCallCodec(handler, EVENT_VIDEO_CALL_CODEC, phone);
        /* @} */
    }
    ...
    private void unregisterForPhoneStates(Phone phone) {
        ...
        /* SPRD: add for bug479433 @{ */
        phone.unregisterForPreciseVideoCallStateChanged(handler);
        phone.unregisterForVideoCallDisconnect(handler);
        phone.unregisterForVideoCallFallBack(handler);
        phone.unregisterForVideoCallFail(handler);
        phone.unregisterForVideoCallCodec(handler);
        /* @} */
    }
