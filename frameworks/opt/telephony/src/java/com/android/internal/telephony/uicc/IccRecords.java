...
public abstract class IccRecords extends Handler implements IccConstants {
    ...
    /* SPRD: [bug452051] Notify observers AID ready after AID loaded @{ */
    protected RegistrantList mAidReadyRegistrants = new RegistrantList();
    ...
    protected String mOns; // SPRD: add by EXT
    ...
    /* SPRD: [bug452051] Notify observers AID ready after AID loaded @{ */
    public void registerForAidReady(Handler h, int what, Object obj) {
        if (mDestroyed.get()) {
            return;
        }

        Registrant r = new Registrant(h, what, obj);
        mAidReadyRegistrants.add(r);
    ...
    public void unregisterForAidReady(Handler h) {
        mAidReadyRegistrants.remove(h);
    }
    /* @} */
    ...
    protected void setServiceProviderName(String spn) {
        // SPRD: [Bug495584] Translate operator name string into Chinese if under Chinese language.
