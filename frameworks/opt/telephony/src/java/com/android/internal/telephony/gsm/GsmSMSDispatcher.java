...
public final class GsmSMSDispatcher extends SMSDispatcher {
    ...
    protected void sendData(String destAddr, String scAddr, int destPort,
        ...
        SmsMessage.getSmsValidity(mContext, mPhone.getSubId());//SPRD add for Bug 489211
    ...
    public static final String SMS_ENCODE_TYPE = "persist.radio.sms_encode_type";//Add for Encode type feature (562203)
...
//                scAddr, destAddr, text, (deliveryIntent != null));
        ...
        Rlog.d(TAG+" - encodeTypeLog", " - GsmSMSDispatcher - sendText->> encodeType :" + encodeType);
        pdu = SmsMessage.getSubmitPdu(
                scAddr, destAddr, text, (deliveryIntent != null), null, encoding, 0, 0);
