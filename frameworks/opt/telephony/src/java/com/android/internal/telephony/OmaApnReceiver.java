...
public class OmaApnReceiver extends BroadcastReceiver {
    ...
    public void putContentValuesNull(ContentValues contentValues){
        contentValues.putNull(Telephony.Carriers.TYPE);
        contentValues.putNull(Telephony.Carriers.NAME);
        contentValues.putNull(Telephony.Carriers.USER);
        contentValues.putNull(Telephony.Carriers.PASSWORD);
        contentValues.putNull(Telephony.Carriers.PROXY);
        contentValues.putNull(Telephony.Carriers.PORT);
        contentValues.putNull(Telephony.Carriers.MMSC);
        contentValues.putNull(Telephony.Carriers.MMSPROXY);
        contentValues.putNull(Telephony.Carriers.MMSPORT);
    }
