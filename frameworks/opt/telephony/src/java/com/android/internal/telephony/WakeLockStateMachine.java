...
public abstract class WakeLockStateMachine extends StateMachine {
    ...
    public static final int EVENT_NEW_SMS_MESSAGE_LTE = 5;
    ...
    class IdleState extends State {
        ...
        public boolean processMessage(Message msg) {
            switch (msg.what) {
                ...
                case EVENT_NEW_SMS_MESSAGE_LTE:
                    log("handle EVENT_NEW_SPRD_SMS_MESSAGE");
                    if (handleSmsMessageLte(msg)) {
                        transitionTo(mWaitingState);
                    }
                    return HANDLED;
    ...
    protected abstract boolean handleSmsMessageLte(Message message);
    /**
