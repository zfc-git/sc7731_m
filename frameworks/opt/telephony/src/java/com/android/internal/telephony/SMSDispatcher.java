...
public abstract class SMSDispatcher extends Handler {
    ...
    protected void handleSendComplete(AsyncResult ar) {
        ...
        if (ar.exception == null) {
            ...
            if ( tracker.mImsRetry > 0 && ss != ServiceState.STATE_IN_SERVICE) {
                // This is retry after failure over IMS but voice is not
                // available.
                ...
                Rlog.d(TAG, "handleSendComplete: Skipping retry: "
                        + " isIms()=" + isIms() + " mRetryCount="
                        + tracker.mRetryCount + " mImsRetry="
                        + tracker.mImsRetry + " mMessageRef="
                        + tracker.mMessageRef + " mRetryCount= "
                        + tracker.mRetryCount + " SS= "
            ...
            if (!isIms() && ss != ServiceState.STATE_IN_SERVICE) {
                tracker.onFailed(mContext, getNotInServiceError(ss), 0/*errorCode*/);
                   ...
                   tracker.mRetryCount < getMaxSendRetries()/*MAX_SEND_RETRIES*/) {
                ...
                Log.i(TAG, "Retry SMS send failed[" + tracker.mRetryCount
                        + "]  MAX RETRY =[" + getMaxSendRetries() + "]");
                tracker.mRetryCount++;
    ...
    protected void sendMultipartText(String destAddr, String scAddr,
        ...
        Rlog.d(TAG+"-encodeTypeLog", "-SMSDispatcher-sendMultipartText->> encodeType :" + encoding);
    ...
    private int getMaxSendRetries() {
       // int smsMaxRetries = -1;
       // smsMaxRetries = Integer.valueOf(Settings.Global.getInt(mContext.getContentResolver(), SEND_RETRIE_TIME,-1));
