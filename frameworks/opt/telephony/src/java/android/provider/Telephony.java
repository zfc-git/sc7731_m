    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static final class Intents {
            ...
            public static SmsMessage[] getMessagesFromIntent(Intent intent) {
                ...
                if (null == messages) {
                    System.out.println("messages is null in getMessagesFromIntent(),will return null");
                    return null;
                }
...
//                    msgs[i] = SmsMessage.createFromPdu(pdu, format);
            ...
            /**
             * Read the PDUs out of an {@link #SMS_RECEIVED_ACTION} 
             * @return an array of SmsMessages for the PDUs
             */
            public static SmsMessage[] getMessagesFromIntentEX(byte[][] puds , int subId) {
                Object[] messages = (Object[])(puds);
                int pduCount = messages.length;
                SmsMessage[] msgs = new SmsMessage[pduCount];
...
//                    msgs[i] = SmsMessage.createFromPdu(pdu, format);
    ...
    public static final class Carriers implements BaseColumns {
        ...
        /**
         * SPRD: Add the traffic class when activate the PDP.
         * @hide
         */
