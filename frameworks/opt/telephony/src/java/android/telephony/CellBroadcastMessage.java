...
public class CellBroadcastMessage implements Parcelable {
     ...
     * modify the valide sub_id for App bug 489257
     *
     * @hide
     */
    public int getSubId() {
    ...
    public static CellBroadcastMessage createFromCursor(Cursor cursor) {
        ...
        // SPRD: Modify this method for multi-sim mode.bug 489257
        int subColumn = cursor.getColumnIndex("sub_id");
        int subId = cursor.getInt(subColumn);
    ...
    // SPRD: add for bug#446725
    public boolean removeOldCb(){
        return mSmsCbMessage.removeOldCb();
    }
    public SmsCbLocation getLocation(){
        return mSmsCbMessage.getLocation();
    }
}
