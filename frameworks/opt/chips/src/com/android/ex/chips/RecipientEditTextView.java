...
public class RecipientEditTextView extends MultiAutoCompleteTextView implements
    ...
    public RecipientEditTextView(Context context, AttributeSet attrs) {
        ...
        mAlternatesListener = new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView,View view, int position,
                ...
                // SPRD: Bug 404537 - Don't replace chip if mSelectedChip is null.
        ...
        /* Messaging recipients check boxes,select all not's Click{@ */
        setCustomInsertionActionModeCallback(new ActionMode.Callback2() {
            @Override
    ...
    public boolean onEditorAction(TextView view, int action, KeyEvent keyEvent) {
        if (action == EditorInfo.IME_ACTION_DONE) {
            /*
             * SPRD: add if mAddressPopup,Messaging number Pop up box , click "virtual" key
             * confirmation key,disappear the checkbox; @{
             */
    ...
    private void showAlternates(final DrawableRecipientChip currentChip,
        ...
        // SPRD: Bug 396014 - constructStateListDeleteDrawable() may depends on main thread.
        final StateListDrawable deleteDrawable = constructStateListDeleteDrawable();

        new AsyncTask<Void, Void, ListAdapter>() {
            @Override
            protected ListAdapter doInBackground(final Void... params) {
                // SPRD: Bug 396014 - Use the method that doesn't depend on
                // constructStateListDeleteDrawable().
                return createAlternatesAdapter(currentChip, deleteDrawable);
            }
    ...
    // SPRD: Bug 396014 - Add a method that doesn't depend on constructStateListDeleteDrawable().
    private ListAdapter createAlternatesAdapter(DrawableRecipientChip chip,
