...
public class TimeZoneInfo implements Comparable<TimeZoneInfo> {
    ...
    private static int[] getTransitions(TimeZone tz, long time)
        ...
        /* SPRD: modify 20151102 Spreadtrum of 491479 avoid calendar crash
         * this is a temporary solution, we need waiting for google patch and revert it @{ */
        ...
        if (objTransitions.length != 0) {
            ...
            for (int i = 0; i < objTransitions.length; ++i) {
                ...
                /* SPRD: modify 20151102 Spreadtrum of 491479 avoid calendar crash
                 * this is a temporary solution, we need waiting for google patch and revert it @{ */
                transitions[numOfTransitions++] = (int) objTransitions[i];
                /* @} */
