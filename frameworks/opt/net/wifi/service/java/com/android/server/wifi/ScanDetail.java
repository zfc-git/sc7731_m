...
public class ScanDetail {
    ...
    public void setPasspointMatches(Map<HomeSP, PasspointMatch> matches, PasspointMatchInfo bestMatch) {
        if (bestMatch != null) {
            mMatches = matches;
            mScanResult.hasPasspointMatches = true;
            mScanResult.passpointCredIdentifier = bestMatch.getHomeSP().getConfigKey();
        } else {
            mMatches = null;
            mScanResult.hasPasspointMatches = false;
            mScanResult.passpointCredIdentifier = null;
        }
    }

    public boolean hasPasspointMatches() {
        return (mMatches == null ? false : true);
    }
