...
public class ImsManager {
    ...
    public static final String EXTRA_IMS_UNKNOWN_CALL =
            "android.intent.extra.EXTRA_IMS_UNKNOWN_CALL";
    public static final String EXTRA_IMS_UNKNOWN_CALL_STATE =
            "android.intent.extra.EXTRA_IMS_UNKNOWN_CALL_STATE";
    public static final String EXTRA_IMS_UNKNOWN_CALL_ADDRESS =
            "android.intent.extra.EXTRA_IMS_UNKNOWN_CALL_ADDRESS";
    private IImsUtEx mIImsUtEx = null;
    /* @} */
    ...
    public static void setEnhanced4gLteModeSetting(Context context, boolean enabled) {
        ...
        if (isNonTtyOrTtyOnVolteEnabled(context)) {
            /* SPRD: Added for BUG 551592 @{ */
            TelephonyManager teleMgr = TelephonyManager.from(context);
            /* @} */
            ImsManager imsManager = ImsManager.getInstance(context,/*SPRD: modify for bug 551592*/
                    teleMgr.getPrimaryCard());
            if (imsManager != null) {
                try {
    ...
    public static boolean isVolteProvisionedOnDevice(Context context) {
        ...
        if (getBooleanCarrierConfig(context,
            ...
            /*SPRD: Bug 551462 Sprd Use primary card phoneId instead of default voice phoneId to get ImsManager and ImsConfig objects.
             *@orig
             *
    ...
    public ImsUtInterface getSupplementaryServiceConfiguration(int serviceId)
        ...
        if (mUt == null) {
            ...
            try {
                ...
                mUt = new ImsUt(iUt ,mIImsUtEx); //SPRD:add IImsUtEx for VoLTE
            } catch (RemoteException e) {
    ...
    private void createImsService(boolean checkService) {
        ...
        /* SPRD: Added for VoLTE @{ */
        IBinder utBinder = ServiceManager.getService("imsutex");
        if(utBinder != null){
            mIImsUtEx = IImsUtEx.Stub.asInterface(utBinder);
        }
        log("createImsService->mIImsUtEx:"+mIImsUtEx);
        /* @} */
    }
