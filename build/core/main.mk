...
SPRD_MCP_XLS:=vendor/sprd/component/mcp.xls
SPRD_MCP_INI:=device/sprd/$(TARGET_DEVICE)/mcp_config.ini
KERNEL_SPRD_NAND_PARAM_H:=kernel/drivers/mtd/nand/sprd_nand_param.h
$(KERNEL_SPRD_NAND_PARAM_H):$(SPRD_MCP_XLS)
	@echo "Start to autogenerate kernel sprd_nand_param.h"
	@perl vendor/sprd/open-source/tools/mcp_gen/nandgen.pl -h $(KERNEL_SPRD_NAND_PARAM_H) -i $(SPRD_MCP_INI)

$(INSTALLED_BOOTIMAGE_TARGET):$(KERNEL_SPRD_NAND_PARAM_H)
...
$(CHIPRAM_SPRD_NAND_PARAM_H):$(SPRD_MCP_XLS)
	...
	@perl vendor/sprd/open-source/tools/mcp_gen/nandgen.pl -h $(CHIPRAM_SPRD_NAND_PARAM_H) -i $(SPRD_MCP_INI)
